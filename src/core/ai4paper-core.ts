...
var AI4PaperCore = (() => {
  ...
  function getColorHexByLabel(label: string | null | undefined): string {
    if (!label) {
      return "";
    }
  ...
  function getSelectedVocabularyColor(): string {
    return getColorHexByLabel(getPref(AI4PaperPrefs.KEYS.annotationColorSelect));
  }

  function isVocabularyAnnotation(annotation: AnnotationLike | null | undefined): boolean {
    if (!annotation) {
      return false;
    }
  ...
  function getExcludedAnnotationRule(setting: string | null | undefined): ExcludedAnnotationRule {
  ...
  function isExcludedAnnotation(
    annotation: AnnotationLike | null | undefined,
    setting: string | null | undefined = getPref(AI4PaperPrefs.KEYS.autoAnnotationsColorExcluded)
  ): boolean {
    if (!annotation) {
      return false;
    }
  ...
  function shouldSkipAutoAnnotation(annotation: AnnotationLike | null | undefined): boolean {
    if (!annotation) {
      return false;
    }
