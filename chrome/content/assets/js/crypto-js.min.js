    ...
    !function () {
      ...
      for (var e = 2, r = 0; r < 64;) {
        !function (t) {
          ...
          return 1;
        }(e) || (r < 8 && (o[r] = t(n.pow(e, .5))), p[r] = t(n.pow(e, 0.3333333333333333)), r++);
        e++;
      }
    }();
    var _ = [],
    ...
    e = e.SHA3 = i.extend({
      ...
      _doProcessBlock: function (t, e) {
        ...
        for (var c = 0; c < 24; c++) {
          ...
          for (a = 0; a < 5; a++) for (var u = C[(a + 4) % 5], p = C[(a + 1) % 5], _ = p.high, p = p.low, h = u.high ^ (_ << 1 | p >>> 31), l = u.low ^ (p << 1 | _ >>> 31), f = 0; f < 5; f++) {
            (m = r[a + 5 * f]).high ^= h;
            m.low ^= l;
          }
          for (var y = 1; y < 25; y++) {
