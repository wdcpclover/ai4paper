...
!function (t, e) {
  "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).markdownit = e();
}(this, function () {
  "use strict";
  ...
  function n(t, e, s) {
    ...
    for (let e = 0, r = t.length; e < r; e++) {
      ...
      if (s && 37 === n && e + 2 < r && /^[0-9a-f]{2}$/i.test(t.slice(e + 1, e + 3))) {
        o += t.slice(e, e + 3);
        e += 2;
      } else if (n < 128) o += i[n];else if (n >= 55296 && n <= 57343) {
        if (n >= 55296 && n <= 56319 && e + 1 < r) {
          const r = t.charCodeAt(e + 1);
          if (r >= 56320 && r <= 57343) {
            o += encodeURIComponent(t[e] + t[e + 1]);
            e++;
            continue;
          }
        }
  ...
  i.prototype.parse = function (t, e) {
    ...
    let u = o.exec(i);
    if (u && (u = u[0], r = u.toLowerCase(), this.protocol = u, i = i.substr(u.length)), (e || u || i.match(/^\/\/[^@\/]+@[^@\/]+/)) && (s = "//" === i.substr(0, 2), !s || u && _[u] || (i = i.substr(2), this.slashes = true)), !_[u] && (s || u && !m[u])) {
      let t,
        e,
        r = -1;
  ...
  const v = new Map([[0, 65533], [128, 8364], [130, 8218], [131, 402], [132, 8222], [133, 8230], [134, 8224], [135, 8225], [136, 710], [137, 8240], [138, 352], [139, 8249], [140, 338], [142, 381], [145, 8216], [146, 8217], [147, 8220], [148, 8221], [149, 8226], [150, 8211], [151, 8212], [152, 732], [153, 8482], [154, 353], [155, 8250], [156, 339], [158, 382], [159, 376]]),
    z = null !== (k = String.fromCodePoint) && undefined !== k ? k : function (t) {
      let e = "";
  ...
  class R {
    ...
    addToNumericResult(t, e, r, n) {
      if (e !== r) {
        const s = r - e;
        this.result = this.result * Math.pow(n, s) + parseInt(t.substr(e, s), n);
        this.consumed += s;
      }
    }
    stateNumericHex(t, e) {
    ...
    emitNumericEntity(t, e) {
      var r;
      if (this.consumed <= e) return null === (r = this.errors) || undefined === r || r.absenceOfDigitsInNumericCharacterReference(this.consumed), 0;
      if (t === S.SEMI) this.consumed += 1;else if (this.decodeMode === L.Strict) return 0;
      return this.emitCodePoint(function (t) {
        var e;
        return t >= 55296 && t <= 57343 || t > 1114111 ? 65533 : null !== (e = v.get(t)) && undefined !== e ? e : t;
    ...
    emitNotTerminatedNamedEntity() {
      ...
      return this.emitNamedEntityData(e, n, this.consumed), null === (t = this.errors) || undefined === t || t.missingSemicolonAfterCharacterReference(), this.consumed;
    }
    emitNamedEntityData(t, e, r) {
      ...
      switch (this.state) {
        ...
        case B.NumericStart:
          return null === (t = this.errors) || undefined === t || t.absenceOfDigitsInNumericCharacterReference(this.consumed), 0;
        case B.EntityStart:
          return 0;
      }
    }
  ...
  var ht = Object.freeze({
    ...
    parseLinkDestination: function (t, e, r) {
      ...
      if (60 === t.charCodeAt(s)) {
        for (s++; s < r;) {
          ...
          if (60 === n) return i;
          if (62 === n) return i.pos = s + 1, i.str = X(t.slice(e + 1, s)), i.ok = true, i;
          92 === n && s + 1 < r ? s += 2 : s++;
        }
        return i;
      }
      ...
      return e === s || 0 !== o || (i.str = X(t.slice(e, s)), i.pos = s, i.ok = true), i;
    },
    ...
    parseLinkTitle: function (t, e, r, n) {
      ...
      for (; i < r;) {
        if (s = t.charCodeAt(i), s === o.marker) return o.pos = i + 1, o.str += X(t.slice(e, i)), o.ok = true, o;
        if (40 === s && 41 === o.marker) return o;
        92 === s && i + 1 < r && i++;
        i++;
      }
      return o.can_continue = true, o.str += X(t.slice(e, i)), o;
    }
  });
  const pt = {};
  function ft() {
  ...
  ft.prototype.renderToken = function (t, e, r) {
    ...
    let i = false;
    if (n.block && (i = true, 1 === n.nesting && e + 1 < t.length)) {
      const r = t[e + 1];
      ("inline" === r.type || r.hidden || -1 === r.nesting && r.tag === n.tag) && (i = false);
    }
    return s += i ? ">\n" : ">", s;
  };
  ft.prototype.renderInline = function (t, e, r) {
    ...
    for (let i = 0, o = t.length; i < o; i++) {
      const o = t[i].type;
      undefined !== s[o] ? n += s[o](t, i, e, r, this) : n += this.renderToken(t, i, e);
    }
    return n;
  };
  ...
  ft.prototype.render = function (t, e, r) {
    ...
    for (let i = 0, o = t.length; i < o; i++) {
      const o = t[i].type;
      "inline" === o ? n += this.renderInline(t[i].children, e, r) : undefined !== s[o] ? n += s[o](t, i, e, r, this) : n += this.renderToken(t, i, e, r);
    }
    return n;
  };
  ...
  function xt(t) {
    ...
    for (let r = t.length - 1; r >= 0; r--) {
      const n = t[r];
      "text" !== n.type || e || Ct.test(n.content) && (n.content = n.content.replace(/\+-/g, "\xb1").replace(/\.{2,}/g, "\u2026").replace(/([?!])\u2026/g, "$1..").replace(/([?!]){4,}/g, "$1$1$1").replace(/,{2,}/g, ",").replace(/(^|[^-])---(?=[^-]|$)/gm, "$1\u2014").replace(/(^|\s)--(?=\s|$)/gm, "$1\u2013").replace(/(^|[^-\s])--(?=[^-\s]|$)/gm, "$1\u2013"));
      "link_open" === n.type && "auto" === n.info && e--;
      "link_close" === n.type && "auto" === n.info && e++;
    }
  }
  ...
  function qt(t, e) {
    ...
    for (let s = 0; s < t.length; s++) {
      ...
      t: for (; c < a;) {
        ...
        const f = "'" === l[0];
        let d = 32;
        if (l.index - 1 >= 0) d = u.charCodeAt(l.index - 1);else for (r = s - 1; r >= 0 && "softbreak" !== t[r].type && "hardbreak" !== t[r].type; r--) if (t[r].content) {
          d = t[r].content.charCodeAt(t[r].content.length - 1);
          break;
        }
        let _ = 32;
        if (c < a) _ = u.charCodeAt(c);else for (r = s + 1; r < t.length && "softbreak" !== t[r].type && "hardbreak" !== t[r].type; r++) if (t[r].content) {
        ...
        const m = ut(d) || ot(String.fromCharCode(d)),
          ...
          k = it(d),
          D = it(_);
        if (D ? h = false : g && (k || m || (h = false)), k ? p = false : m && (D || g || (p = false)), 34 === _ && '"' === l[0] && d >= 48 && d <= 57 && (p = h = false), h && p && (h = m, p = g), h || p) {
          if (p) for (r = n.length - 1; r >= 0; r--) {
            let h = n[r];
  ...
  const Bt = [["normalize", function (t) {
    ...
    const e = t.tokens;
    var r;
    if (t.md.options.linkify) for (let n = 0, s = e.length; n < s; n++) {
    ...
    if (t.md.options.typographer) for (let e = t.tokens.length - 1; e >= 0; e--) "inline" === t.tokens[e].type && wt.test(t.tokens[e].content) && qt(t.tokens[e].children, t);
  ...
  function It(t, e, r, n) {
    ...
    this.level = 0;
    const s = this.src;
    for (let t = 0, e = 0, r = 0, n = 0, i = s.length, o = false; e < i; e++) {
      ...
      10 !== u && e !== i - 1 || (10 !== u && e++, this.bMarks.push(t), this.eMarks.push(e), this.tShift.push(r), this.sCount.push(n), this.bsCount.push(0), o = false, r = 0, n = 0, t = e + 1);
    }
  ...
  It.prototype.getLines = function (t, e, r, n) {
    ...
    for (let i = 0, o = t; o < e; o++, i++) {
      ...
      for (c = o + 1 < e || n ? this.eMarks[o] + 1 : this.eMarks[o]; a < c && t < r;) {
        ...
        if (st(e)) 9 === e ? t += 4 - (t + this.bsCount[o]) % 4 : t++;else {
  ...
  const Pt = "<[A-Za-z][A-Za-z0-9\\-]*(?:\\s+[a-zA-Z_:][a-zA-Z0-9:._-]*(?:\\s*=\\s*(?:[^\"'=<>`\\x00-\\x20]+|'[^']*'|\"[^\"]*\"))?)*\\s*\\/?>",
    ...
    Zt = new RegExp("^(?:" + Pt + "|" + Ot + ")"),
    $t = [[/^<(script|pre|style|textarea)(?=(\s|>|$))/i, /<\/(script|pre|style|textarea)>/i, true], [/^<!--/, /-->/, true], [/^<\?/, /\?>/, true], [/^<![A-Z]/, />/, true], [/^<!\[CDATA\[/, /\]\]>/, true], [new RegExp("^</?(" + ["address", "article", "aside", "base", "basefont", "blockquote", "body", "caption", "center", "col", "colgroup", "dd", "details", "dialog", "dir", "div", "dl", "dt", "fieldset", "figcaption", "figure", "footer", "form", "frame", "frameset", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hr", "html", "iframe", "legend", "li", "link", "main", "menu", "menuitem", "nav", "noframes", "ol", "optgroup", "option", "p", "param", "search", "section", "summary", "table", "tbody", "td", "tfoot", "th", "thead", "title", "tr", "track", "ul"].join("|") + ")(?=(\\s|/?>|$))", "i"), /^$/, true], [new RegExp(Zt.source + "\\s*$"), /^$/, false]];
  const Ut = [["table", function (t, e, r, n) {
    if (e + 2 > r) return false;
    let s = e + 1;
    if (t.sCount[s] < t.blkIndent) return false;
    if (t.sCount[s] - t.blkIndent >= 4) return false;
    let i = t.bMarks[s] + t.tShift[s];
    if (i >= t.eMarks[s]) return false;
    const o = t.src.charCodeAt(i++);
    if (124 !== o && 45 !== o && 58 !== o) return false;
    if (i >= t.eMarks[s]) return false;
    const u = t.src.charCodeAt(i++);
    if (124 !== u && 45 !== u && 58 !== u && !st(u)) return false;
    if (45 === o && st(u)) return false;
    for (; i < t.eMarks[s];) {
      const e = t.src.charCodeAt(i);
      if (124 !== e && 45 !== e && 58 !== e && !st(e)) return false;
      i++;
    }
    let c = Mt(t, e + 1),
      a = c.split("|");
    ...
    if (c = Mt(t, e).trim(), -1 === c.indexOf("|")) return false;
    if (t.sCount[e] - t.blkIndent >= 4) return false;
    a = Tt(c);
    a.length && "" === a[0] && a.shift();
    a.length && "" === a[a.length - 1] && a.pop();
    const h = a.length;
    if (0 === h || h !== l.length) return false;
    if (n) return true;
    ...
    for (s = e + 2; s < r && !(t.sCount[s] < t.blkIndent); s++) {
      let n = false;
      for (let e = 0, i = f.length; e < i; e++) if (f[e](t, s, r, true)) {
        n = true;
        break;
      }
      if (n) break;
    ...
    return _ && (t.push("tbody_close", "tbody", -1), _[1] = s), t.push("table_close", "table", -1), d[1] = s, t.parentType = p, t.line = s, true;
    ...
    return i.content = t.getLines(e, s, 4 + t.blkIndent, false) + "\n", i.map = [e, t.line], true;
  }], ["fence", function (t, e, r, n) {
    let s = t.bMarks[e] + t.tShift[e],
      i = t.eMarks[e];
    if (t.sCount[e] - t.blkIndent >= 4) return false;
    if (s + 3 > i) return false;
    const o = t.src.charCodeAt(s);
    if (126 !== o && 96 !== o) return false;
    let u = s;
    s = t.skipChars(s, o);
    let c = s - u;
    if (c < 3) return false;
    const a = t.src.slice(u, s),
      l = t.src.slice(s, i);
    if (96 === o && l.indexOf(String.fromCharCode(o)) >= 0) return false;
    if (n) return true;
    let h = e,
      p = false;
    ...
    return f.info = l, f.content = t.getLines(e + 1, h, c, true), f.markup = a, f.map = [e, t.line], true;
  }, ["paragraph", "reference", "blockquote", "list"]], ["blockquote", function (t, e, r, n) {
    let s = t.bMarks[e] + t.tShift[e],
      i = t.eMarks[e];
    const o = t.lineMax;
    if (t.sCount[e] - t.blkIndent >= 4) return false;
    if (62 !== t.src.charCodeAt(s)) return false;
    if (n) return true;
    const u = [],
      c = [],
      a = [],
    ...
    for (f = e; f < r; f++) {
      ...
      if (62 === t.src.charCodeAt(s++) && !e) {
        let e,
          r,
          n = t.sCount[f] + 1;
        32 === t.src.charCodeAt(s) ? (s++, n++, r = false, e = true) : 9 === t.src.charCodeAt(s) ? (e = true, (t.bsCount[f] + n) % 4 == 3 ? (s++, n++, r = false) : r = true) : e = false;
        let o = n;
      ...
      if (d) break;
      let n = false;
      for (let e = 0, s = h.length; e < s; e++) if (h[e](t, f, r, true)) {
        n = true;
        break;
      }
      if (n) {
    ...
    return c.map = [e, t.line], c.markup = Array(u + 1).join(String.fromCharCode(o)), true;
    ...
    let s,
      ...
      c = e,
      a = true;
    if (t.sCount[c] - t.blkIndent >= 4) return false;
    if (t.listIndent >= 0 && t.sCount[c] - t.listIndent >= 4 && t.sCount[c] < t.blkIndent) return false;
    let l,
      h,
      p,
      f = false;
    if (n && "paragraph" === t.parentType && t.sCount[c] >= t.blkIndent && (f = true), (p = Nt(t, c)) >= 0) {
      if (l = true, o = t.bMarks[c] + t.tShift[c], h = Number(t.src.slice(o, p - 1)), f && 1 !== h) return false;
    } else {
      if (!((p = Rt(t, c)) >= 0)) return false;
      l = false;
    }
    if (f && t.skipSpaces(p) >= t.eMarks[c]) return false;
    if (n) return true;
    ...
    for (t.parentType = "list"; c < r;) {
      ...
      for (; i < s;) {
        const e = t.src.charCodeAt(i);
        if (9 === e) n += 4 - (n + t.bsCount[c]) % 4;else {
          if (32 !== e) break;
          n++;
        }
        i++;
      ...
      const m = [c, 0];
      u.map = m;
      l && (u.info = t.src.slice(o, p - 1));
      const D = t.tight,
        C = t.tShift[c],
        y = t.sCount[c],
        E = t.listIndent;
      if (t.listIndent = t.blkIndent, t.blkIndent = _, t.tight = true, t.tShift[c] = h - t.bMarks[c], t.sCount[c] = n, h >= s && t.isEmpty(c + 1) ? t.line = Math.min(t.line + 2, r) : t.md.block.tokenize(t, c, r, true), t.tight && !g || (a = false), g = t.line - c > 1 && t.isEmpty(t.line - 1), t.blkIndent = t.listIndent, t.listIndent = E, t.tShift[c] = C, t.sCount[c] = y, t.tight = D, u = t.push("list_item_close", "li", -1), u.markup = String.fromCharCode(d), c = t.line, m[1] = c, c >= r) break;
      if (t.sCount[c] < t.blkIndent) break;
      if (t.sCount[c] - t.blkIndent >= 4) break;
      let A = false;
      for (let e = 0, n = k.length; e < n; e++) if (k[e](t, c, r, true)) {
        A = true;
        break;
      }
      if (A) break;
    ...
    return u = l ? t.push("ordered_list_close", "ol", -1) : t.push("bullet_list_close", "ul", -1), u.markup = String.fromCharCode(d), m[1] = c, t.line = c, t.parentType = D, a && function (t, e) {
      const r = t.level + 2;
      for (let n = e + 2, s = t.tokens.length - 2; n < s; n++) t.tokens[n].level === r && "paragraph_open" === t.tokens[n].type && (t.tokens[n + 2].hidden = true, t.tokens[n].hidden = true, n += 2);
    }(t, _), true;
    ...
    let s = t.bMarks[e] + t.tShift[e],
      ...
      o = e + 1;
    if (t.sCount[e] - t.blkIndent >= 4) return false;
    if (91 !== t.src.charCodeAt(s)) return false;
    function u(e) {
      const r = t.lineMax;
      if (e >= r || t.isEmpty(e)) return null;
      let n = false;
      if (t.sCount[e] - t.blkIndent > 3 && (n = true), t.sCount[e] < 0 && (n = true), !n) {
        const n = t.md.block.ruler.getRules("reference"),
          s = t.parentType;
        t.parentType = "reference";
        let i = false;
        for (let s = 0, o = n.length; s < o; s++) if (n[s](t, e, r, true)) {
          i = true;
          break;
        }
    ...
    if (a < 0 || 58 !== c.charCodeAt(a + 1)) return false;
    for (s = a + 2; s < i; s++) {
      const t = c.charCodeAt(s);
      if (10 === t) {
        const t = u(o);
    ...
    if (!t.md.validateLink(h)) return false;
    s = l.pos;
    const p = s,
      f = o,
      d = s;
    ...
    if (s < i && 10 !== c.charCodeAt(s)) return false;
    const g = ct(c.slice(1, a));
    return !!g && (n || (undefined === t.env.references && (t.env.references = {}), undefined === t.env.references[g] && (t.env.references[g] = {
      title: _,
      href: h
    }), t.line = o), true);
    ...
    let s = t.bMarks[e] + t.tShift[e],
      i = t.eMarks[e];
    if (t.sCount[e] - t.blkIndent >= 4) return false;
    if (!t.md.options.html) return false;
    if (60 !== t.src.charCodeAt(s)) return false;
    ...
    return l.content = t.src.slice(s, i).trim(), l.map = [e, t.line], l.children = [], t.push("heading_close", "h" + String(u), -1).markup = "########".slice(0, u), true;
    ...
    for (; u < r && !t.isEmpty(u); u++) {
      ...
      let e = false;
      for (let s = 0, i = n.length; s < i; s++) if (n[s](t, u, r, true)) {
        e = true;
        break;
      }
      if (e) break;
    ...
    if (!o) return false;
    const c = t.getLines(e, u, t.blkIndent, false).trim();
    t.line = u + 1;
    const a = t.push("heading_open", "h" + String(o), 1);
    a.markup = String.fromCharCode(i);
    a.map = [e, t.line];
    const l = t.push("inline", "", 0);
    return l.content = c, l.map = [e, t.line - 1], l.children = [], t.push("heading_close", "h" + String(o), -1).markup = String.fromCharCode(i), t.parentType = s, true;
    ...
    for (t.parentType = "paragraph"; i < r && !t.isEmpty(i); i++) {
      ...
      let e = false;
      for (let s = 0, o = n.length; s < o; s++) if (n[s](t, i, r, true)) {
        e = true;
        break;
      }
      if (e) break;
    }
    const o = t.getLines(e, i, t.blkIndent, false).trim();
    t.line = i;
    t.push("paragraph_open", "p", 1).map = [e, t.line];
    const u = t.push("inline", "", 0);
    return u.content = o, u.map = [e, t.line], u.children = [], t.push("paragraph_close", "p", -1), t.parentType = s, true;
  }]];
  function Ht() {
    this.ruler = new dt();
  ...
  function Qt(t, e) {
    ...
    for (; n.length;) {
      ...
      s--;
      e !== s && (r = t.tokens[s], t.tokens[s] = t.tokens[e], t.tokens[e] = r);
    }
  }
  ...
  var Xt = {
    tokenize: function (t, e) {
      ...
      if (e) return false;
      if (126 !== n) return false;
      const s = t.scanDelims(t.pos, true);
      let i = s.length;
    ...
    for (let o = 0; o < r; o++) {
      ...
      for (; c > u; c -= i[c] + 1) {
        ...
        if (e.marker === r.marker && e.open && e.end < 0) {
          let n = false;
          if ((e.close || r.open) && (e.length + r.length) % 3 == 0 && (e.length % 3 == 0 && r.length % 3 == 0 || (n = true)), !n) {
  ...
  const ie = [["text", function (t, e) {
      let r = t.pos;
      for (; r < t.posMax && !Gt(t.src.charCodeAt(r));) r++;
      return r !== t.pos && (e || (t.pending += t.src.slice(t.pos, r)), t.pos = r, true);
    }], ["linkify", function (t, e) {
      if (!t.md.options.linkify) return false;
      if (t.linkLevel > 0) return false;
      const r = t.pos;
      if (r + 3 > t.posMax) return false;
      if (58 !== t.src.charCodeAt(r)) return false;
      if (47 !== t.src.charCodeAt(r + 1)) return false;
      if (47 !== t.src.charCodeAt(r + 2)) return false;
      ...
      if (!t.md.validateLink(u)) return false;
      if (!e) {
      ...
      return t.pos += o.length - s.length, true;
    }], ["newline", function (t, e) {
      let r = t.pos;
      if (10 !== t.src.charCodeAt(r)) return false;
      ...
      let r = t.pos;
      const n = t.posMax;
      if (92 !== t.src.charCodeAt(r)) return false;
      ...
      return t.pos = r + 1, true;
    }], ["backticks", function (t, e) {
      let r = t.pos;
      if (96 !== t.src.charCodeAt(r)) return false;
      const n = r;
      r++;
      const s = t.posMax;
      ...
      const i = t.src.slice(n, r),
        o = i.length;
      if (t.backticksScanned && (t.backticks[o] || 0) <= n) return e || (t.pending += i), t.pos += o, true;
      let u,
        c = r;
      for (; -1 !== (u = t.src.indexOf("`", c));) {
        ...
        if (n === o) {
          if (!e) {
            ...
            e.markup = i;
            e.content = t.src.slice(r, u).replace(/\n/g, " ").replace(/^ (.+) $/, "$1");
          }
          return t.pos = c, true;
        }
        t.backticks[n] = u;
      }
      return t.backticksScanned = true, e || (t.pending += i), t.pos += o, true;
      ...
      let r,
        ...
        c = t.pos,
        a = true;
      if (91 !== t.src.charCodeAt(t.pos)) return false;
      const l = t.pos,
        h = t.posMax,
        p = t.pos + 1,
        f = t.md.helpers.parseLinkLabel(t, t.pos, true);
      if (f < 0) return false;
      let d = f + 1;
      if (d < h && 40 === t.src.charCodeAt(d)) {
        for (a = false, d++; d < h && (r = t.src.charCodeAt(d), st(r) || 10 === r); d++);
        if (d >= h) return false;
        ...
        (d >= h || 41 !== t.src.charCodeAt(d)) && (a = true);
        d++;
      }
      if (a) {
        if (undefined === t.env.references) return false;
        if (d < h && 91 === t.src.charCodeAt(d) ? (c = d + 1, d = t.md.helpers.parseLinkLabel(t, d), d >= 0 ? n = t.src.slice(c, d++) : d = f + 1) : d = f + 1, n || (n = t.src.slice(p, f)), i = t.env.references[ct(n)], !i) return t.pos = l, false;
        o = i.href;
        u = i.title;
      }
      if (!e) {
      ...
      return t.pos = d, t.posMax = h, true;
    }], ["image", function (t, e) {
      let r,
        n,
        s,
      ...
      const h = t.pos,
        p = t.posMax;
      if (33 !== t.src.charCodeAt(t.pos)) return false;
      if (91 !== t.src.charCodeAt(t.pos + 1)) return false;
      const f = t.pos + 2,
        d = t.md.helpers.parseLinkLabel(t, t.pos + 1, false);
      if (d < 0) return false;
      if (i = d + 1, i < p && 40 === t.src.charCodeAt(i)) {
        ...
        if (i >= p || 41 !== t.src.charCodeAt(i)) return t.pos = h, false;
        i++;
      } else {
        if (undefined === t.env.references) return false;
        if (i < p && 91 === t.src.charCodeAt(i) ? (a = i + 1, i = t.md.helpers.parseLinkLabel(t, i), i >= 0 ? s = t.src.slice(a, i++) : i = d + 1) : i = d + 1, s || (s = t.src.slice(f, d)), o = t.env.references[ct(s)], !o) return t.pos = h, false;
        l = o.href;
        c = o.title;
      }
      if (!e) {
      ...
      return t.pos = i, t.posMax = p, true;
    }], ["autolink", function (t, e) {
      let r = t.pos;
      if (60 !== t.src.charCodeAt(r)) return false;
      const n = t.pos,
        s = t.posMax;
      for (;;) {
        if (++r >= s) return false;
        const e = t.src.charCodeAt(r);
        if (60 === e) return false;
        if (62 === e) break;
      }
      const i = t.src.slice(n + 1, r);
      if (ee.test(i)) {
        const r = t.md.normalizeLink(i);
        if (!t.md.validateLink(r)) return false;
        if (!e) {
          const e = t.push("link_open", "a", 1);
          e.attrs = [["href", r]];
          e.markup = "autolink";
      ...
      const r = t.posMax,
        n = t.pos;
      if (60 !== t.src.charCodeAt(n) || n + 2 >= r) return false;
      ...
      var o;
      return t.pos += i[0].length, true;
    }], ["entity", function (t, e) {
      const r = t.pos,
        n = t.posMax;
      if (38 !== t.src.charCodeAt(r)) return false;
    ...
    oe = [["balance_pairs", function (t) {
      ...
      for (e = r = 0; e < i; e++) {
        ...
        s[e].level = n;
        s[e].nesting > 0 && n++;
        "text" === s[e].type && e + 1 < i && "text" === s[e + 1].type ? s[e + 1].content = s[e].content + s[e + 1].content : (e !== r && (s[r] = s[e]), r++);
      }
      e !== r && (s.length = r);
    }]];
  function ue() {
  ...
  ue.prototype.skipToken = function (t) {
    const e = t.pos,
      ...
      i = t.cache;
    if (undefined !== i[e]) return void (t.pos = i[e]);
    let o = false;
    if (t.level < s) {
      for (let s = 0; s < n; s++) if (t.level++, o = r[s](t, true), t.level--, o) {
  ...
  ue.prototype.tokenize = function (t) {
    ...
    for (; t.pos < n;) {
      const i = t.pos;
      let o = false;
      if (t.level < s) for (let n = 0; n < r; n++) if (o = e[n](t, false), o) {
  ...
  De.prototype.tlds = function (t, e) {
    return t = Array.isArray(t) ? t : [t], e ? (this.__tlds__ = this.__tlds__.concat(t).sort().filter(function (t, e, r) {
      return t !== r[e - 1];
    }).reverse(), me(this), this) : (this.__tlds__ = t.slice(), this.__tlds_replaced__ = true, me(this), this);
  };
  ...
  const qe = function (t, e) {
    ...
    Ie = function (t) {
      ...
      for (o && e.push("-"); u < r;) {
        ...
        s += (r - n) * c;
        n = r;
        for (const r of t) if (r < n && ++s > Ce && ve("overflow"), r === n) {
          let t = s;
          for (let r = ye;; r += ye) {
  ...
  return $e.prototype.set = function (t) {
    ...
    r = r.concat(this.inline.ruler2.enable(t, true));
    ...
    r = r.concat(this.inline.ruler2.disable(t, true));
    const n = t.filter(function (t) {
      return r.indexOf(t) < 0;
    });
