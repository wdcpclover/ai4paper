!function (e, t) {
  ...
  var f = {},
    ...
    b = /^([^:]+:\/*[^/]*)[\s\S]*$/;
  function m(e, t) {
    f[" " + e] || (d.test(e) ? f[" " + e] = e + "/" : f[" " + e] = x(e, "/", true));
    var n = -1 === (e = f[" " + e]).indexOf(":");
    return "//" === t.substring(0, 2) ? n ? t : e.replace(k, "$1") + t : "/" === t.charAt(0) ? n ? t : e.replace(b, "$1") + t : e + t;
  }
  function x(e, t, n) {
    var r = e.length;
    if (0 === r) return "";
  ...
  var w = function (e, t) {
    ...
    _ = function (n, e) {
      ...
      var r = {
        replace: function (e, t) {
          return t = (t = t.source || t).replace(u, "$1"), n = n.replace(e, t), r;
        },
        getRegex: function () {
    ...
    S = function (e, t) {
      var n = e.replace(/\|/g, function (e, t, n) {
          for (var r = false, i = t; 0 <= --i && "\\" === n[i];) r = !r;
          return r ? "|" : " |";
        }).split(/ \|/),
        r = 0;
  ...
  var E = function () {
      ...
      return t.space = function (e) {
        ...
        if (n) {
          var r = t[t.length - 1];
          if (r && "paragraph" === r.type) return t.pop(), r.text += "\n" + n[0].trimRight(), r.raw += "\n" + n[0], r;
        ...
        if (t) {
          for (var n, r, i, s, a, l, o, c = t[0], h = t[2], u = 1 < h.length, p = {
              ...
              loose: false,
              items: []
            }, g = t[0].match(this.rules.block.item), f = false, d = g.length, k = 0; k < d; k++) {
            r = (c = n = g[k]).length;
            ~(n = n.replace(/^ *([*+-]|\d+\.) */, "")).indexOf("\n ") && (r -= n.length, n = this.options.pedantic ? n.replace(/^ {1,4}/gm, "") : n.replace(new RegExp("^ {1," + r + "}", "gm"), ""));
            k !== d - 1 && (i = this.rules.block.bullet.exec(g[k + 1])[0], (1 < h.length ? 1 === i.length : 1 < i.length || this.options.smartLists && i !== h) && (s = g.slice(k + 1).join("\n"), p.raw = p.raw.substring(0, p.raw.length - s.length), k = d - 1));
            a = f || /\n\n(?!\s*$)/.test(n);
        ...
        if (r) return !t && /^<a /i.test(r[0]) ? t = true : t && /^<\/a>/i.test(r[0]) && (t = false), !n && /^<(pre|code|kbd|script)(\s|>)/i.test(r[0]) ? n = true : n && /^<\/(pre|code|kbd|script)(\s|>)/i.test(r[0]) && (n = false), {
        ...
        if (i) return r = "@" === i[2] ? "mailto:" + (n = C(this.options.mangle ? t(i[1]) : i[1])) : n = C(i[1]), {
          type: "link",
          raw: i[0],
          text: n,
          href: r,
        ...
        if (i) return r = t ? this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(i[0]) : C(i[0]) : i[0] : C(this.options.smartypants ? n(i[0]) : i[0]), {
          type: "text",
          raw: i[0],
          text: r
        };
  ...
  U.def = L(U.def).replace("label", U._label).replace("title", U._title).getRegex();
  U.bullet = /(?:[*+-]|\d{1,9}\.)/;
  U.item = /^( *)(bull) ?[^\n]*(?:\n(?!\1bull ?)[^\n]*)*/;
  U.item = L(U.item, "gm").replace(/bull/g, U.bullet).getRegex();
  U.list = L(U.list).replace(/bull/g, U.bullet).replace("hr", "\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))").replace("def", "\\n+(?=" + U.def.source + ")").getRegex();
  U._tag = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul";
  U._comment = /<!--(?!-?>)[\s\S]*?-->/;
  U.html = L(U.html, "i").replace("comment", U._comment).replace("tag", U._tag).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex();
  U.paragraph = L(U._paragraph).replace("hr", U.hr).replace("heading", " {0,3}#{1,6} ").replace("|lheading", "").replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|!--)").replace("tag", U._tag).getRegex();
  U.blockquote = L(U.blockquote).replace("paragraph", U.paragraph).getRegex();
  U.normal = P({}, U);
  U.gfm = P({}, U.normal, {
  ...
  U.gfm.table = L(U.gfm.table).replace("hr", U.hr).replace("heading", " {0,3}#{1,6} ").replace("blockquote", " {0,3}>").replace("code", " {4}[^\\n]").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|!--)").replace("tag", U._tag).getRegex();
  U.pedantic = P({}, U.normal, {
    html: L("^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:\"[^\"]*\"|'[^']*'|\\s[^'\"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))").replace("comment", U._comment).replace(/tag/g, "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),
    def: /^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,
    heading: /^ *(#{1,6}) *([^\n]+?) *(?:#+ *)?(?:\n+|$)/,
    fences: j,
    paragraph: L(U.normal._paragraph).replace("hr", U.hr).replace("heading", " *#{1,6} *[^\n]").replace("lheading", U.lheading).replace("blockquote", " {0,3}>").replace("|fences", "").replace("|list", "").replace("|html", "").getRegex()
  });
  var B = {
    escape: /^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,
  ...
  B.em = L(B.em).replace(/punctuation/g, B._punctuation).getRegex();
  B._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g;
  ...
  B.autolink = L(B.autolink).replace("scheme", B._scheme).replace("email", B._email).getRegex();
  B._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/;
  B.tag = L(B.tag).replace("comment", U._comment).replace("attribute", B._attribute).getRegex();
  B._label = /(?:\[[^\[\]]*\]|\\.|`[^`]*`|[^\[\]\\`])*?/;
  B._href = /<(?:\\[<>]?|[^\s<>\\])*>|[^\s\x00-\x1f]*/;
  B._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/;
  B.link = L(B.link).replace("label", B._label).replace("href", B._href).replace("title", B._title).getRegex();
  B.reflink = L(B.reflink).replace("label", B._label).getRegex();
  B.normal = P({}, B);
  B.pedantic = P({}, B.normal, {
    strong: /^__(?=\S)([\s\S]*?\S)__(?!_)|^\*\*(?=\S)([\s\S]*?\S)\*\*(?!\*)/,
    em: /^_(?=\S)([\s\S]*?\S)_(?!_)|^\*(?=\S)([\s\S]*?\S)\*(?!\*)/,
    link: L(/^!?\[(label)\]\((.*?)\)/).replace("label", B._label).getRegex(),
    reflink: L(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label", B._label).getRegex()
  });
  B.gfm = P({}, B.normal, {
  ...
  B.gfm.url = L(B.gfm.url, "i").replace("email", B.gfm._extended_email).getRegex();
  B.breaks = P({}, B.gfm, {
    br: L(B.br).replace("{2,}", "*").getRegex(),
    text: L(B.gfm.text).replace("\\b_", "\\b_| {2,}\\n").replace(/\{2,\}/g, "*").getRegex()
  });
  var F = {
      block: U,
      inline: B
  ...
  var H = function () {
      function n(e) {
        ...
        this.options.pedantic ? (t.block = X.pedantic, t.inline = G.pedantic) : this.options.gfm && (t.block = X.gfm, this.options.breaks ? t.inline = G.breaks : t.inline = G.gfm);
      ...
      return i.lex = function (e) {
        return e = e.replace(/\r\n|\r/g, "\n").replace(/\t/g, "    "), this.blockTokens(e, this.tokens, true), this.inline(this.tokens), this.tokens;
      }, i.blockTokens = function (e, t, n) {
        var r, i, s;
        for (undefined === t && (t = []), undefined === n && (n = true), e = e.replace(/^ +$/gm, ""); e;) if (r = this.tokenizer.space(e)) {
          ...
          for (e = e.substring(r.raw.length), s = r.items.length, i = 0; i < s; i++) r.items[i].tokens = this.blockTokens(r.items[i].text, [], false);
          t.push(r);
        ...
        for (t = 0; t < l; t++) switch ((a = e[t]).type) {
          ...
          case "table":
            ...
            for (i = a.cells.length, n = 0; n < i; n++) for (s = a.cells[n], a.tokens.cells[n] = [], r = 0; r < s.length; r++) {
              a.tokens.cells[n][r] = [];
        ...
        var i;
        for (undefined === t && (t = []), undefined === n && (n = false), undefined === r && (r = false); e;) if (i = this.tokenizer.escape(e)) {
          ...
          e = e.substring(i.raw.length);
          "link" === i.type && (i.tokens = this.inlineTokens(i.text, [], true, r));
          t.push(i);
    ...
    W = function () {
      ...
      return t.code = function (e, t, n) {
        ...
        if (this.options.highlight) {
          ...
          null != i && i !== e && (n = true, e = i);
        }
        return r ? '<pre><code class="' + this.options.langPrefix + Q(r, true) + '">' + (n ? e : Q(e, true)) + "</code></pre>\n" : "<pre><code>" + (n ? e : Q(e, true)) + "</code></pre>";
      }, t.blockquote = function (e) {
        return "<blockquote>\n" + e + "</blockquote>\n";
      }, t.html = function (e) {
        return e;
    ...
    re = function () {
      ...
      return e.parse = function (e, t) {
        ...
        var n,
          ...
          w = "",
          v = e.length;
        for (n = 0; n < v; n++) switch ((u = e[n]).type) {
          case "space":
            continue;
          case "hr":
            w += this.renderer.hr();
            continue;
          case "heading":
            w += this.renderer.heading(this.parseInline(u.tokens), u.depth, ne(this.parseInline(u.tokens, this.textRenderer)), this.slugger);
            continue;
          case "code":
            w += this.renderer.code(u.text, u.lang, u.escaped);
            continue;
          case "table":
            for (o = c = "", s = u.header.length, r = 0; r < s; r++) o += this.renderer.tablecell(this.parseInline(u.tokens.header[r]), {
              header: true,
              align: u.align[r]
            });
            for (c += this.renderer.tablerow(o), h = "", s = u.cells.length, r = 0; r < s; r++) {
              for (o = "", a = (l = u.tokens.cells[r]).length, i = 0; i < a; i++) o += this.renderer.tablecell(this.parseInline(l[i]), {
                header: false,
                align: u.align[i]
              });
            ...
            continue;
          case "blockquote":
            h = this.parse(u.tokens);
            w += this.renderer.blockquote(h);
            continue;
          case "list":
            for (p = u.ordered, g = u.start, f = u.loose, s = u.items.length, h = "", r = 0; r < s; r++) {
              b = (k = u.items[r]).checked;
              m = k.task;
              d = "";
              k.task && (x = this.renderer.checkbox(b), f ? "text" === k.tokens[0].type ? (k.tokens[0].text = x + " " + k.tokens[0].text, k.tokens[0].tokens && 0 < k.tokens[0].tokens.length && "text" === k.tokens[0].tokens[0].type && (k.tokens[0].tokens[0].text = x + " " + k.tokens[0].tokens[0].text)) : k.tokens.unshift({
                type: "text",
                text: x
              }) : d += x);
          ...
          case "paragraph":
            ...
            continue;
          case "text":
            for (h = u.tokens ? this.parseInline(u.tokens) : u.text; n + 1 < v && "text" === e[n + 1].type;) h += "\n" + ((u = e[++n]).tokens ? this.parseInline(u.tokens) : u.text);
        ...
        var n,
          ...
          i = "",
          s = e.length;
        for (n = 0; n < s; n++) switch ((r = e[n]).type) {
          case "escape":
            i += t.text(r.text);
            break;
          case "html":
  ...
  function he(t, a, l) {
    ...
    if (l || "function" == typeof a) {
      var e = function () {
        ...
        if (delete a.highlight, !r) return {
          v: s()
        };
        for (; e < n.length; e++) !function (n) {
          "code" !== n.type ? --r || s() : i(n.text, n.lang, function (e, t) {
            return e ? s(e) : null == t || t === n.text ? --r || s() : (n.text = t, n.escaped = true, void (--r || s()));
          });
        }(n[e]);
        return {
          v: undefined
    ...
    try {
      return a = ie({}, he.defaults, a || {}), se(a), re.parse(H.lex(t, a), a);
    } catch (e) {
      if (e.message += "\nPlease report this to https://github.com/markedjs/marked.", (a || he.defaults).silent) return "<p>An error occurred:</p><pre>" + ae(e.message + "", true) + "</pre>";
      throw e;
    }
  }
  return he.options = he.setOptions = function (e) {
    return ie(he.defaults, e), oe(he.defaults), he;
  }, he.getDefaults = le, he.defaults = ce, he.use = function (l) {
    var n = ie({}, l);
    l.renderer && function () {
      function e(i) {
        var s = a[i];
        a[i] = function () {
          ...
          return false === r && (r = s.apply(a, t)), r;
        };
      }
    ...
    he.setOptions(n);
  }, he.Parser = re, he.parser = re.parse, he.Renderer = W, he.TextRenderer = Y, he.Lexer = H, he.lexer = H.lex, he.Tokenizer = E, he.Slugger = ee, he.parse = he;
});