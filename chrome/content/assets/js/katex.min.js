!function (e, t) {
  ...
  return function () {
    ...
    var c = function () {
        ...
        return t.reportNonstrict = function (e, t, r) {
          ...
          if ("function" == typeof a && (a = a(e, t, r)), a && "ignore" !== a) {
            if (true === a || "error" === a) throw new n("LaTeX-incompatible input and strict mode is set to 'error': " + t + " [" + e + "]", r);
          ...
          return !(!n || "ignore" === n) && (true === n || "error" === n || ("warn" === n ? ("undefined" != typeof console && console.warn("LaTeX-incompatible input and strict mode is set to 'warn': " + t + " [" + e + "]"), false) : ("undefined" != typeof console && console.warn("LaTeX-incompatible input and strict mode is set to unrecognized '" + n + "': " + t + " [" + e + "]"), false)));
      ...
      p = [new u(0, 0, false), new u(1, 0, true), new u(2, 1, false), new u(3, 1, true), new u(4, 2, false), new u(5, 2, true), new u(6, 3, false), new u(7, 3, true)],
      d = [4, 5, 4, 5, 6, 7, 6, 7],
      f = [5, 5, 5, 5, 7, 7, 7, 7],
      g = [2, 3, 4, 5, 6, 7, 6, 7],
      v = [3, 3, 5, 5, 7, 7, 7, 7],
    ...
    var k = [];
    function S(e) {
      for (var t = 0; t < k.length; t += 2) if (e >= k[t] && e <= k[t + 1]) return true;
      return false;
    }
    ...
    var E = H,
      ...
      Z = function () {
        ...
        return t.hasClass = function (e) {
          ...
          var e = false,
            t = "<span";
          this.classes.length && (e = true, t += ' class="', t += l.escape(G(this.classes)), t += '"');
          var r = "";
    ...
    var oe = "math",
      ...
      ye = "spacing",
      xe = "textord";
    ie(oe, le, be, "\u2261", "\\equiv", true);
    ie(oe, le, be, "\u227a", "\\prec", true);
    ie(oe, le, be, "\u227b", "\\succ", true);
    ie(oe, le, be, "\u223c", "\\sim", true);
    ie(oe, le, be, "\u22a5", "\\perp");
    ie(oe, le, be, "\u2aaf", "\\preceq", true);
    ie(oe, le, be, "\u2ab0", "\\succeq", true);
    ie(oe, le, be, "\u2243", "\\simeq", true);
    ie(oe, le, be, "\u2223", "\\mid", true);
    ie(oe, le, be, "\u226a", "\\ll", true);
    ie(oe, le, be, "\u226b", "\\gg", true);
    ie(oe, le, be, "\u224d", "\\asymp", true);
    ie(oe, le, be, "\u2225", "\\parallel");
    ie(oe, le, be, "\u22c8", "\\bowtie", true);
    ie(oe, le, be, "\u2323", "\\smile", true);
    ie(oe, le, be, "\u2291", "\\sqsubseteq", true);
    ie(oe, le, be, "\u2292", "\\sqsupseteq", true);
    ie(oe, le, be, "\u2250", "\\doteq", true);
    ie(oe, le, be, "\u2322", "\\frown", true);
    ie(oe, le, be, "\u220b", "\\ni", true);
    ie(oe, le, be, "\u221d", "\\propto", true);
    ie(oe, le, be, "\u22a2", "\\vdash", true);
    ie(oe, le, be, "\u22a3", "\\dashv", true);
    ie(oe, le, be, "\u220b", "\\owns");
    ie(oe, le, ve, ".", "\\ldotp");
    ie(oe, le, ve, "\u22c5", "\\cdotp");
    ie(oe, le, xe, "#", "\\#");
    ...
    ie(oe, le, xe, "&", "\\&");
    ie(se, le, xe, "&", "\\&");
    ie(oe, le, xe, "\u2135", "\\aleph", true);
    ie(oe, le, xe, "\u2200", "\\forall", true);
    ie(oe, le, xe, "\u210f", "\\hbar", true);
    ie(oe, le, xe, "\u2203", "\\exists", true);
    ie(oe, le, xe, "\u2207", "\\nabla", true);
    ie(oe, le, xe, "\u266d", "\\flat", true);
    ie(oe, le, xe, "\u2113", "\\ell", true);
    ie(oe, le, xe, "\u266e", "\\natural", true);
    ie(oe, le, xe, "\u2663", "\\clubsuit", true);
    ie(oe, le, xe, "\u2118", "\\wp", true);
    ie(oe, le, xe, "\u266f", "\\sharp", true);
    ie(oe, le, xe, "\u2662", "\\diamondsuit", true);
    ie(oe, le, xe, "\u211c", "\\Re", true);
    ie(oe, le, xe, "\u2661", "\\heartsuit", true);
    ie(oe, le, xe, "\u2111", "\\Im", true);
    ie(oe, le, xe, "\u2660", "\\spadesuit", true);
    ie(oe, le, xe, "\xa7", "\\S", true);
    ie(se, le, xe, "\xa7", "\\S");
    ie(oe, le, xe, "\xb6", "\\P", true);
    ie(se, le, xe, "\xb6", "\\P");
    ie(oe, le, xe, "\u2020", "\\dag");
    ie(se, le, xe, "\u2020", "\\dag");
    ...
    ie(oe, le, ue, "\u23b1", "\\rmoustache", true);
    ie(oe, le, ge, "\u23b0", "\\lmoustache", true);
    ie(oe, le, ue, "\u27ef", "\\rgroup", true);
    ie(oe, le, ge, "\u27ee", "\\lgroup", true);
    ie(oe, le, ce, "\u2213", "\\mp", true);
    ie(oe, le, ce, "\u2296", "\\ominus", true);
    ie(oe, le, ce, "\u228e", "\\uplus", true);
    ie(oe, le, ce, "\u2293", "\\sqcap", true);
    ie(oe, le, ce, "\u2217", "\\ast");
    ie(oe, le, ce, "\u2294", "\\sqcup", true);
    ie(oe, le, ce, "\u25ef", "\\bigcirc", true);
    ie(oe, le, ce, "\u2219", "\\bullet");
    ie(oe, le, ce, "\u2021", "\\ddagger");
    ie(oe, le, ce, "\u2240", "\\wr", true);
    ie(oe, le, ce, "\u2a3f", "\\amalg");
    ie(oe, le, ce, "&", "\\And");
    ie(oe, le, be, "\u27f5", "\\longleftarrow", true);
    ie(oe, le, be, "\u21d0", "\\Leftarrow", true);
    ie(oe, le, be, "\u27f8", "\\Longleftarrow", true);
    ie(oe, le, be, "\u27f6", "\\longrightarrow", true);
    ie(oe, le, be, "\u21d2", "\\Rightarrow", true);
    ie(oe, le, be, "\u27f9", "\\Longrightarrow", true);
    ie(oe, le, be, "\u2194", "\\leftrightarrow", true);
    ie(oe, le, be, "\u27f7", "\\longleftrightarrow", true);
    ie(oe, le, be, "\u21d4", "\\Leftrightarrow", true);
    ie(oe, le, be, "\u27fa", "\\Longleftrightarrow", true);
    ie(oe, le, be, "\u21a6", "\\mapsto", true);
    ie(oe, le, be, "\u27fc", "\\longmapsto", true);
    ie(oe, le, be, "\u2197", "\\nearrow", true);
    ie(oe, le, be, "\u21a9", "\\hookleftarrow", true);
    ie(oe, le, be, "\u21aa", "\\hookrightarrow", true);
    ie(oe, le, be, "\u2198", "\\searrow", true);
    ie(oe, le, be, "\u21bc", "\\leftharpoonup", true);
    ie(oe, le, be, "\u21c0", "\\rightharpoonup", true);
    ie(oe, le, be, "\u2199", "\\swarrow", true);
    ie(oe, le, be, "\u21bd", "\\leftharpoondown", true);
    ie(oe, le, be, "\u21c1", "\\rightharpoondown", true);
    ie(oe, le, be, "\u2196", "\\nwarrow", true);
    ie(oe, le, be, "\u21cc", "\\rightleftharpoons", true);
    ie(oe, he, be, "\u226e", "\\nless", true);
    ie(oe, he, be, "\ue010", "\\@nleqslant");
    ie(oe, he, be, "\ue011", "\\@nleqq");
    ie(oe, he, be, "\u2a87", "\\lneq", true);
    ie(oe, he, be, "\u2268", "\\lneqq", true);
    ie(oe, he, be, "\ue00c", "\\@lvertneqq");
    ie(oe, he, be, "\u22e6", "\\lnsim", true);
    ie(oe, he, be, "\u2a89", "\\lnapprox", true);
    ie(oe, he, be, "\u2280", "\\nprec", true);
    ie(oe, he, be, "\u22e0", "\\npreceq", true);
    ie(oe, he, be, "\u22e8", "\\precnsim", true);
    ie(oe, he, be, "\u2ab9", "\\precnapprox", true);
    ie(oe, he, be, "\u2241", "\\nsim", true);
    ...
    ie(oe, he, be, "\u22ea", "\\ntriangleleft");
    ie(oe, he, be, "\u22ec", "\\ntrianglelefteq", true);
    ie(oe, he, be, "\u228a", "\\subsetneq", true);
    ie(oe, he, be, "\ue01a", "\\@varsubsetneq");
    ie(oe, he, be, "\u2acb", "\\subsetneqq", true);
    ie(oe, he, be, "\ue017", "\\@varsubsetneqq");
    ie(oe, he, be, "\u226f", "\\ngtr", true);
    ie(oe, he, be, "\ue00f", "\\@ngeqslant");
    ie(oe, he, be, "\ue00e", "\\@ngeqq");
    ie(oe, he, be, "\u2a88", "\\gneq", true);
    ie(oe, he, be, "\u2269", "\\gneqq", true);
    ie(oe, he, be, "\ue00d", "\\@gvertneqq");
    ie(oe, he, be, "\u22e7", "\\gnsim", true);
    ie(oe, he, be, "\u2a8a", "\\gnapprox", true);
    ie(oe, he, be, "\u2281", "\\nsucc", true);
    ie(oe, he, be, "\u22e1", "\\nsucceq", true);
    ie(oe, he, be, "\u22e9", "\\succnsim", true);
    ie(oe, he, be, "\u2aba", "\\succnapprox", true);
    ie(oe, he, be, "\u2246", "\\ncong", true);
    ...
    ie(oe, he, be, "\u228b", "\\supsetneq", true);
    ie(oe, he, be, "\ue01b", "\\@varsupsetneq");
    ie(oe, he, be, "\u2acc", "\\supsetneqq", true);
    ie(oe, he, be, "\ue019", "\\@varsupsetneqq");
    ie(oe, he, be, "\u22ae", "\\nVdash", true);
    ie(oe, he, be, "\u2ab5", "\\precneqq", true);
    ie(oe, he, be, "\u2ab6", "\\succneqq", true);
    ...
    ie(oe, he, xe, "\u2221", "\\measuredangle", true);
    ie(oe, he, xe, "\u2204", "\\nexists");
    ie(oe, he, xe, "\u2127", "\\mho");
    ie(oe, he, xe, "\u2132", "\\Finv", true);
    ie(oe, he, xe, "\u2141", "\\Game", true);
    ...
    ie(oe, he, xe, "\u2605", "\\bigstar");
    ie(oe, he, xe, "\u2222", "\\sphericalangle", true);
    ie(oe, he, xe, "\u2201", "\\complement", true);
    ie(oe, he, xe, "\xf0", "\\eth", true);
    ie(se, le, xe, "\xf0", "\xf0");
    ie(oe, he, xe, "\u2571", "\\diagup");
    ...
    ie(oe, he, xe, "\u25a1", "\\Box");
    ie(oe, he, xe, "\u25ca", "\\Diamond");
    ie(oe, he, xe, "\xa5", "\\yen", true);
    ie(se, he, xe, "\xa5", "\\yen", true);
    ie(oe, he, xe, "\u2713", "\\checkmark", true);
    ie(se, he, xe, "\u2713", "\\checkmark");
    ie(oe, he, xe, "\u2136", "\\beth", true);
    ie(oe, he, xe, "\u2138", "\\daleth", true);
    ie(oe, he, xe, "\u2137", "\\gimel", true);
    ie(oe, he, xe, "\u03dd", "\\digamma", true);
    ie(oe, he, xe, "\u03f0", "\\varkappa");
    ie(oe, he, ge, "\u250c", "\\@ulcorner", true);
    ie(oe, he, ue, "\u2510", "\\@urcorner", true);
    ie(oe, he, ge, "\u2514", "\\@llcorner", true);
    ie(oe, he, ue, "\u2518", "\\@lrcorner", true);
    ie(oe, he, be, "\u2266", "\\leqq", true);
    ie(oe, he, be, "\u2a7d", "\\leqslant", true);
    ie(oe, he, be, "\u2a95", "\\eqslantless", true);
    ie(oe, he, be, "\u2272", "\\lesssim", true);
    ie(oe, he, be, "\u2a85", "\\lessapprox", true);
    ie(oe, he, be, "\u224a", "\\approxeq", true);
    ie(oe, he, ce, "\u22d6", "\\lessdot");
    ie(oe, he, be, "\u22d8", "\\lll", true);
    ie(oe, he, be, "\u2276", "\\lessgtr", true);
    ie(oe, he, be, "\u22da", "\\lesseqgtr", true);
    ie(oe, he, be, "\u2a8b", "\\lesseqqgtr", true);
    ie(oe, he, be, "\u2251", "\\doteqdot");
    ie(oe, he, be, "\u2253", "\\risingdotseq", true);
    ie(oe, he, be, "\u2252", "\\fallingdotseq", true);
    ie(oe, he, be, "\u223d", "\\backsim", true);
    ie(oe, he, be, "\u22cd", "\\backsimeq", true);
    ie(oe, he, be, "\u2ac5", "\\subseteqq", true);
    ie(oe, he, be, "\u22d0", "\\Subset", true);
    ie(oe, he, be, "\u228f", "\\sqsubset", true);
    ie(oe, he, be, "\u227c", "\\preccurlyeq", true);
    ie(oe, he, be, "\u22de", "\\curlyeqprec", true);
    ie(oe, he, be, "\u227e", "\\precsim", true);
    ie(oe, he, be, "\u2ab7", "\\precapprox", true);
    ie(oe, he, be, "\u22b2", "\\vartriangleleft");
    ie(oe, he, be, "\u22b4", "\\trianglelefteq");
    ie(oe, he, be, "\u22a8", "\\vDash", true);
    ie(oe, he, be, "\u22aa", "\\Vvdash", true);
    ie(oe, he, be, "\u2323", "\\smallsmile");
    ie(oe, he, be, "\u2322", "\\smallfrown");
    ie(oe, he, be, "\u224f", "\\bumpeq", true);
    ie(oe, he, be, "\u224e", "\\Bumpeq", true);
    ie(oe, he, be, "\u2267", "\\geqq", true);
    ie(oe, he, be, "\u2a7e", "\\geqslant", true);
    ie(oe, he, be, "\u2a96", "\\eqslantgtr", true);
    ie(oe, he, be, "\u2273", "\\gtrsim", true);
    ie(oe, he, be, "\u2a86", "\\gtrapprox", true);
    ie(oe, he, ce, "\u22d7", "\\gtrdot");
    ie(oe, he, be, "\u22d9", "\\ggg", true);
    ie(oe, he, be, "\u2277", "\\gtrless", true);
    ie(oe, he, be, "\u22db", "\\gtreqless", true);
    ie(oe, he, be, "\u2a8c", "\\gtreqqless", true);
    ie(oe, he, be, "\u2256", "\\eqcirc", true);
    ie(oe, he, be, "\u2257", "\\circeq", true);
    ie(oe, he, be, "\u225c", "\\triangleq", true);
    ie(oe, he, be, "\u223c", "\\thicksim");
    ie(oe, he, be, "\u2248", "\\thickapprox");
    ie(oe, he, be, "\u2ac6", "\\supseteqq", true);
    ie(oe, he, be, "\u22d1", "\\Supset", true);
    ie(oe, he, be, "\u2290", "\\sqsupset", true);
    ie(oe, he, be, "\u227d", "\\succcurlyeq", true);
    ie(oe, he, be, "\u22df", "\\curlyeqsucc", true);
    ie(oe, he, be, "\u227f", "\\succsim", true);
    ie(oe, he, be, "\u2ab8", "\\succapprox", true);
    ie(oe, he, be, "\u22b3", "\\vartriangleright");
    ie(oe, he, be, "\u22b5", "\\trianglerighteq");
    ie(oe, he, be, "\u22a9", "\\Vdash", true);
    ie(oe, he, be, "\u2223", "\\shortmid");
    ie(oe, he, be, "\u2225", "\\shortparallel");
    ie(oe, he, be, "\u226c", "\\between", true);
    ie(oe, he, be, "\u22d4", "\\pitchfork", true);
    ie(oe, he, be, "\u221d", "\\varpropto");
    ie(oe, he, be, "\u25c0", "\\blacktriangleleft");
    ie(oe, he, be, "\u2234", "\\therefore", true);
    ie(oe, he, be, "\u220d", "\\backepsilon");
    ie(oe, he, be, "\u25b6", "\\blacktriangleright");
    ie(oe, he, be, "\u2235", "\\because", true);
    ie(oe, he, be, "\u22d8", "\\llless");
    ie(oe, he, be, "\u22d9", "\\gggtr");
    ie(oe, he, ce, "\u22b2", "\\lhd");
    ie(oe, he, ce, "\u22b3", "\\rhd");
    ie(oe, he, be, "\u2242", "\\eqsim", true);
    ie(oe, le, be, "\u22c8", "\\Join");
    ie(oe, he, be, "\u2251", "\\Doteq", true);
    ie(oe, he, ce, "\u2214", "\\dotplus", true);
    ie(oe, he, ce, "\u2216", "\\smallsetminus");
    ie(oe, he, ce, "\u22d2", "\\Cap", true);
    ie(oe, he, ce, "\u22d3", "\\Cup", true);
    ie(oe, he, ce, "\u2a5e", "\\doublebarwedge", true);
    ie(oe, he, ce, "\u229f", "\\boxminus", true);
    ie(oe, he, ce, "\u229e", "\\boxplus", true);
    ie(oe, he, ce, "\u22c7", "\\divideontimes", true);
    ie(oe, he, ce, "\u22c9", "\\ltimes", true);
    ie(oe, he, ce, "\u22ca", "\\rtimes", true);
    ie(oe, he, ce, "\u22cb", "\\leftthreetimes", true);
    ie(oe, he, ce, "\u22cc", "\\rightthreetimes", true);
    ie(oe, he, ce, "\u22cf", "\\curlywedge", true);
    ie(oe, he, ce, "\u22ce", "\\curlyvee", true);
    ie(oe, he, ce, "\u229d", "\\circleddash", true);
    ie(oe, he, ce, "\u229b", "\\circledast", true);
    ie(oe, he, ce, "\u22c5", "\\centerdot");
    ie(oe, he, ce, "\u22ba", "\\intercal", true);
    ie(oe, he, ce, "\u22d2", "\\doublecap");
    ie(oe, he, ce, "\u22d3", "\\doublecup");
    ie(oe, he, ce, "\u22a0", "\\boxtimes", true);
    ie(oe, he, be, "\u21e2", "\\dashrightarrow", true);
    ie(oe, he, be, "\u21e0", "\\dashleftarrow", true);
    ie(oe, he, be, "\u21c7", "\\leftleftarrows", true);
    ie(oe, he, be, "\u21c6", "\\leftrightarrows", true);
    ie(oe, he, be, "\u21da", "\\Lleftarrow", true);
    ie(oe, he, be, "\u219e", "\\twoheadleftarrow", true);
    ie(oe, he, be, "\u21a2", "\\leftarrowtail", true);
    ie(oe, he, be, "\u21ab", "\\looparrowleft", true);
    ie(oe, he, be, "\u21cb", "\\leftrightharpoons", true);
    ie(oe, he, be, "\u21b6", "\\curvearrowleft", true);
    ie(oe, he, be, "\u21ba", "\\circlearrowleft", true);
    ie(oe, he, be, "\u21b0", "\\Lsh", true);
    ie(oe, he, be, "\u21c8", "\\upuparrows", true);
    ie(oe, he, be, "\u21bf", "\\upharpoonleft", true);
    ie(oe, he, be, "\u21c3", "\\downharpoonleft", true);
    ie(oe, le, be, "\u22b6", "\\origof", true);
    ie(oe, le, be, "\u22b7", "\\imageof", true);
    ie(oe, he, be, "\u22b8", "\\multimap", true);
    ie(oe, he, be, "\u21ad", "\\leftrightsquigarrow", true);
    ie(oe, he, be, "\u21c9", "\\rightrightarrows", true);
    ie(oe, he, be, "\u21c4", "\\rightleftarrows", true);
    ie(oe, he, be, "\u21a0", "\\twoheadrightarrow", true);
    ie(oe, he, be, "\u21a3", "\\rightarrowtail", true);
    ie(oe, he, be, "\u21ac", "\\looparrowright", true);
    ie(oe, he, be, "\u21b7", "\\curvearrowright", true);
    ie(oe, he, be, "\u21bb", "\\circlearrowright", true);
    ie(oe, he, be, "\u21b1", "\\Rsh", true);
    ie(oe, he, be, "\u21ca", "\\downdownarrows", true);
    ie(oe, he, be, "\u21be", "\\upharpoonright", true);
    ie(oe, he, be, "\u21c2", "\\downharpoonright", true);
    ie(oe, he, be, "\u21dd", "\\rightsquigarrow", true);
    ie(oe, he, be, "\u21dd", "\\leadsto");
    ie(oe, he, be, "\u21db", "\\Rrightarrow", true);
    ...
    ie(oe, le, xe, "\u2220", "\\angle", true);
    ie(oe, le, xe, "\u221e", "\\infty", true);
    ie(oe, le, xe, "\u2032", "\\prime");
    ie(oe, le, xe, "\u25b3", "\\triangle");
    ie(oe, le, xe, "\u0393", "\\Gamma", true);
    ie(oe, le, xe, "\u0394", "\\Delta", true);
    ie(oe, le, xe, "\u0398", "\\Theta", true);
    ie(oe, le, xe, "\u039b", "\\Lambda", true);
    ie(oe, le, xe, "\u039e", "\\Xi", true);
    ie(oe, le, xe, "\u03a0", "\\Pi", true);
    ie(oe, le, xe, "\u03a3", "\\Sigma", true);
    ie(oe, le, xe, "\u03a5", "\\Upsilon", true);
    ie(oe, le, xe, "\u03a6", "\\Phi", true);
    ie(oe, le, xe, "\u03a8", "\\Psi", true);
    ie(oe, le, xe, "\u03a9", "\\Omega", true);
    ie(oe, le, xe, "A", "\u0391");
    ie(oe, le, xe, "B", "\u0392");
    ie(oe, le, xe, "E", "\u0395");
    ie(oe, le, xe, "Z", "\u0396");
    ...
    ie(oe, le, de, "\u03b1", "\\alpha", true);
    ie(oe, le, de, "\u03b2", "\\beta", true);
    ie(oe, le, de, "\u03b3", "\\gamma", true);
    ie(oe, le, de, "\u03b4", "\\delta", true);
    ie(oe, le, de, "\u03f5", "\\epsilon", true);
    ie(oe, le, de, "\u03b6", "\\zeta", true);
    ie(oe, le, de, "\u03b7", "\\eta", true);
    ie(oe, le, de, "\u03b8", "\\theta", true);
    ie(oe, le, de, "\u03b9", "\\iota", true);
    ie(oe, le, de, "\u03ba", "\\kappa", true);
    ie(oe, le, de, "\u03bb", "\\lambda", true);
    ie(oe, le, de, "\u03bc", "\\mu", true);
    ie(oe, le, de, "\u03bd", "\\nu", true);
    ie(oe, le, de, "\u03be", "\\xi", true);
    ie(oe, le, de, "\u03bf", "\\omicron", true);
    ie(oe, le, de, "\u03c0", "\\pi", true);
    ie(oe, le, de, "\u03c1", "\\rho", true);
    ie(oe, le, de, "\u03c3", "\\sigma", true);
    ie(oe, le, de, "\u03c4", "\\tau", true);
    ie(oe, le, de, "\u03c5", "\\upsilon", true);
    ie(oe, le, de, "\u03d5", "\\phi", true);
    ie(oe, le, de, "\u03c7", "\\chi", true);
    ie(oe, le, de, "\u03c8", "\\psi", true);
    ie(oe, le, de, "\u03c9", "\\omega", true);
    ie(oe, le, de, "\u03b5", "\\varepsilon", true);
    ie(oe, le, de, "\u03d1", "\\vartheta", true);
    ie(oe, le, de, "\u03d6", "\\varpi", true);
    ie(oe, le, de, "\u03f1", "\\varrho", true);
    ie(oe, le, de, "\u03c2", "\\varsigma", true);
    ie(oe, le, de, "\u03c6", "\\varphi", true);
    ie(oe, le, ce, "\u2217", "*", true);
    ie(oe, le, ce, "+", "+");
    ie(oe, le, ce, "\u2212", "-", true);
    ie(oe, le, ce, "\u22c5", "\\cdot", true);
    ie(oe, le, ce, "\u2218", "\\circ");
    ie(oe, le, ce, "\xf7", "\\div", true);
    ie(oe, le, ce, "\xb1", "\\pm", true);
    ie(oe, le, ce, "\xd7", "\\times", true);
    ie(oe, le, ce, "\u2229", "\\cap", true);
    ie(oe, le, ce, "\u222a", "\\cup", true);
    ie(oe, le, ce, "\u2216", "\\setminus");
    ie(oe, le, ce, "\u2227", "\\land");
    ie(oe, le, ce, "\u2228", "\\lor");
    ie(oe, le, ce, "\u2227", "\\wedge", true);
    ie(oe, le, ce, "\u2228", "\\vee", true);
    ie(oe, le, xe, "\u221a", "\\surd");
    ie(oe, le, ge, "\u27e8", "\\langle", true);
    ie(oe, le, ge, "\u2223", "\\lvert");
    ie(oe, le, ge, "\u2225", "\\lVert");
    ie(oe, le, ue, "?", "?");
    ie(oe, le, ue, "!", "!");
    ie(oe, le, ue, "\u27e9", "\\rangle", true);
    ie(oe, le, ue, "\u2223", "\\rvert");
    ie(oe, le, ue, "\u2225", "\\rVert");
    ie(oe, le, be, "=", "=");
    ie(oe, le, be, ":", ":");
    ie(oe, le, be, "\u2248", "\\approx", true);
    ie(oe, le, be, "\u2245", "\\cong", true);
    ie(oe, le, be, "\u2265", "\\ge");
    ie(oe, le, be, "\u2265", "\\geq", true);
    ie(oe, le, be, "\u2190", "\\gets");
    ie(oe, le, be, ">", "\\gt", true);
    ie(oe, le, be, "\u2208", "\\in", true);
    ie(oe, le, be, "\ue020", "\\@not");
    ie(oe, le, be, "\u2282", "\\subset", true);
    ie(oe, le, be, "\u2283", "\\supset", true);
    ie(oe, le, be, "\u2286", "\\subseteq", true);
    ie(oe, le, be, "\u2287", "\\supseteq", true);
    ie(oe, he, be, "\u2288", "\\nsubseteq", true);
    ie(oe, he, be, "\u2289", "\\nsupseteq", true);
    ie(oe, le, be, "\u22a8", "\\models");
    ie(oe, le, be, "\u2190", "\\leftarrow", true);
    ie(oe, le, be, "\u2264", "\\le");
    ie(oe, le, be, "\u2264", "\\leq", true);
    ie(oe, le, be, "<", "\\lt", true);
    ie(oe, le, be, "\u2192", "\\rightarrow", true);
    ie(oe, le, be, "\u2192", "\\to");
    ie(oe, he, be, "\u2271", "\\ngeq", true);
    ...
    ie(oe, le, ve, ",", ",");
    ie(oe, le, ve, ";", ";");
    ie(oe, he, ce, "\u22bc", "\\barwedge", true);
    ie(oe, he, ce, "\u22bb", "\\veebar", true);
    ie(oe, le, ce, "\u2299", "\\odot", true);
    ie(oe, le, ce, "\u2295", "\\oplus", true);
    ie(oe, le, ce, "\u2297", "\\otimes", true);
    ie(oe, le, xe, "\u2202", "\\partial", true);
    ie(oe, le, ce, "\u2298", "\\oslash", true);
    ie(oe, he, ce, "\u229a", "\\circledcirc", true);
    ie(oe, he, ce, "\u22a1", "\\boxdot", true);
    ...
    ie(oe, le, ge, "{", "\\lbrace");
    ie(oe, le, ue, "}", "\\rbrace");
    ie(oe, le, ge, "[", "\\lbrack", true);
    ie(se, le, xe, "[", "\\lbrack", true);
    ie(oe, le, ue, "]", "\\rbrack", true);
    ie(se, le, xe, "]", "\\rbrack", true);
    ie(oe, le, ge, "(", "\\lparen", true);
    ie(oe, le, ue, ")", "\\rparen", true);
    ie(se, le, xe, "<", "\\textless", true);
    ie(se, le, xe, ">", "\\textgreater", true);
    ie(oe, le, ge, "\u230a", "\\lfloor", true);
    ie(oe, le, ue, "\u230b", "\\rfloor", true);
    ie(oe, le, ge, "\u2308", "\\lceil", true);
    ie(oe, le, ue, "\u2309", "\\rceil", true);
    ie(oe, le, xe, "\\", "\\backslash");
    ie(oe, le, xe, "\u2223", "|");
    ie(oe, le, xe, "\u2223", "\\vert");
    ie(se, le, xe, "|", "\\textbar", true);
    ie(oe, le, xe, "\u2225", "\\|");
    ie(oe, le, xe, "\u2225", "\\Vert");
    ...
    ie(oe, le, be, "\u2191", "\\uparrow", true);
    ie(oe, le, be, "\u21d1", "\\Uparrow", true);
    ie(oe, le, be, "\u2193", "\\downarrow", true);
    ie(oe, le, be, "\u21d3", "\\Downarrow", true);
    ie(oe, le, be, "\u2195", "\\updownarrow", true);
    ie(oe, le, be, "\u21d5", "\\Updownarrow", true);
    ie(oe, le, fe, "\u2210", "\\coprod");
    ie(oe, le, fe, "\u22c1", "\\bigvee");
    ...
    ie(se, le, pe, "\u2026", "\\ldots", true);
    ie(oe, le, pe, "\u2026", "\\ldots", true);
    ie(oe, le, pe, "\u22ef", "\\@cdots", true);
    ie(oe, le, pe, "\u22f1", "\\ddots", true);
    ...
    ie(oe, le, xe, "\u0131", "\u0131");
    ie(oe, le, xe, "\u0237", "\u0237");
    ie(se, le, xe, "\u0131", "\\i", true);
    ie(se, le, xe, "\u0237", "\\j", true);
    ie(se, le, xe, "\xdf", "\\ss", true);
    ie(se, le, xe, "\xe6", "\\ae", true);
    ie(se, le, xe, "\u0153", "\\oe", true);
    ie(se, le, xe, "\xf8", "\\o", true);
    ie(se, le, xe, "\xc6", "\\AE", true);
    ie(se, le, xe, "\u0152", "\\OE", true);
    ie(se, le, xe, "\xd8", "\\O", true);
    ie(se, le, me, "\u02ca", "\\'");
    ie(se, le, me, "\u02cb", "\\`");
    ie(se, le, me, "\u02c6", "\\^");
    ie(se, le, me, "\u02dc", "\\~");
    ...
    ie(oe, le, xe, "\xb0", "\\degree", true);
    ie(se, le, xe, "\xb0", "\\degree");
    ie(se, le, xe, "\xb0", "\\textdegree", true);
    ie(oe, le, xe, "\xa3", "\\pounds");
    ie(oe, le, xe, "\xa3", "\\mathsterling", true);
    ie(se, le, xe, "\xa3", "\\pounds");
    ie(se, le, xe, "\xa3", "\\textsterling", true);
    ie(oe, he, xe, "\u2720", "\\maltese");
    ie(se, he, xe, "\u2720", "\\maltese");
    ...
    for (var Ne = "", Ie = 0; Ie < Be.length; Ie++) {
      ...
      ie(se, le, xe, Re, Ne);
      Ie < 26 && (ie(oe, le, de, Re, Ne = String.fromCharCode(55349, 56632 + Ie)), ie(se, le, xe, Re, Ne), ie(oe, le, de, Re, Ne = String.fromCharCode(55349, 56476 + Ie)), ie(se, le, xe, Re, Ne));
    }
    ie(oe, le, de, "k", Ne = String.fromCharCode(55349, 56668));
    ie(se, le, xe, "k", Ne);
    ...
    var Pe = [["mathbf", "textbf", "Main-Bold"], ["mathbf", "textbf", "Main-Bold"], ["mathnormal", "textit", "Math-Italic"], ["mathnormal", "textit", "Math-Italic"], ["boldsymbol", "boldsymbol", "Main-BoldItalic"], ["boldsymbol", "boldsymbol", "Main-BoldItalic"], ["mathscr", "textscr", "Script-Regular"], ["", "", ""], ["", "", ""], ["", "", ""], ["mathfrak", "textfrak", "Fraktur-Regular"], ["mathfrak", "textfrak", "Fraktur-Regular"], ["mathbb", "textbb", "AMS-Regular"], ["mathbb", "textbb", "AMS-Regular"], ["", "", ""], ["", "", ""], ["mathsf", "textsf", "SansSerif-Regular"], ["mathsf", "textsf", "SansSerif-Regular"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathitsf", "textitsf", "SansSerif-Italic"], ["mathitsf", "textitsf", "SansSerif-Italic"], ["", "", ""], ["", "", ""], ["mathtt", "texttt", "Typewriter-Regular"], ["mathtt", "texttt", "Typewriter-Regular"]],
      Fe = [["mathbf", "textbf", "Main-Bold"], ["", "", ""], ["mathsf", "textsf", "SansSerif-Regular"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathtt", "texttt", "Typewriter-Regular"]],
      Ve = function (e, t, r) {
      ...
      Ue = function (e, t) {
        if (G(e.classes) !== G(t.classes) || e.skew !== t.skew || e.maxFontSize !== t.maxFontSize) return false;
        if (1 === e.classes.length) {
          var r = e.classes[0];
          if ("mbin" === r || "mord" === r) return false;
        }
        for (var n in e.style) if (e.style.hasOwnProperty(n) && e.style[n] !== t.style[n]) return false;
        for (var a in t.style) if (t.style.hasOwnProperty(a) && e.style[a] !== t.style[a]) return false;
        return true;
      },
      Ye = function (e) {
      ...
      Ke = {
        ...
        mathsym: function (e, t, r, n) {
          return undefined === n && (n = []), "boldsymbol" === r.font && Ve(e, "Main-Bold", t).metrics ? Ge(e, "Main-Bold", t, r, n.concat(["mathbf"])) : "\\" === e || "main" === ae[t][e].font ? Ge(e, "Main-Regular", t, r, n) : Ge(e, "AMS-Regular", t, r, n.concat(["amsrm"]));
        },
        makeSpan: Xe,
        makeSvgSpan: We,
    ...
    function ot(e) {
      for (var t = e.type, r = e.names, n = e.props, a = e.handler, i = e.htmlBuilder, o = e.mathmlBuilder, s = {
          ...
          allowedInMath: undefined === n.allowedInMath || n.allowedInMath,
    ...
    function St(e, t) {
      ...
      for (var i, o = [], s = [], l = 0; l < a.length; l++) if (s.push(a[l]), a[l].hasClass("mbin") || a[l].hasClass("mrel") || a[l].hasClass("allowbreak")) {
        for (var h = false; l < a.length - 1 && a[l + 1].hasClass("mspace") && !a[l + 1].hasClass("newline");) {
          l++;
          s.push(a[l]);
          a[l].hasClass("nobreak") && (h = true);
        }
        h || (o.push(kt(s, t)), s = []);
      } else a[l].hasClass("newline") && (s.pop(), s.length > 0 && (o.push(kt(s, t)), s = []), o.push(a[l]));
      s.length > 0 && o.push(kt(s, t));
      r ? ((i = kt(ft(r, t, true))).classes = ["tag"], o.push(i)) : n && o.push(n);
    ...
    var Ht = function (e) {
      ...
      Lt = function (e, t, r) {
        var n,
          a = Ht(r);
        if ("mathml" === r.output) return Ot(e, t, a, r.displayMode, true);
        if ("html" === r.output) {
          var i = St(e, a);
          n = Ke.makeSpan(["katex"], [i]);
        } else {
          var o = Ot(e, t, a, r.displayMode, false),
            s = St(e, a);
    ...
    var Wt = function (e, t) {
        ...
        if (n.isStretchy) {
          ...
          "\\vec" === n.label ? (u = Ke.staticSvg("vec", t), p = Ke.svgData.vec[1]) : ((u = ee(u = Ke.makeOrd({
            mode: n.mode,
            text: n.label
          }, t, "textord"))).italic = 0, p = u.width, m && (c += u.depth));
    ...
    ot({
      ...
      htmlBuilder: function (e, t) {
        ...
        e.below && (a = t.havingStyle(n.sub()), (r = Ke.wrapFragment(wt(e.below, a, t), t)).classes.push(o + "-arrow-pad"));
        var s,
          l = Gt(e, t),
    ...
    var Qt = function (e, t) {
        var r = ft(e.body, t.withColor(e.color), false);
    ...
    ot({
      ...
      handler: function (e, t) {
        ...
        var i = r.parseExpression(true, n);
        return {
          type: "color",
          mode: r.mode,
          color: a,
    ...
    var ar = function (e, t, r) {
      ...
      Ar = {
        ...
        sizedDelim: function (e, t, r, a, i) {
          if ("<" === e || "\\lt" === e || "\u27e8" === e ? e = "\\langle" : ">" !== e && "\\gt" !== e && "\u27e9" !== e || (e = "\\rangle"), l.contains(gr, e) || l.contains(br, e)) return sr(e, t, false, r, a, i);
          if (l.contains(vr, e)) return pr(e, yr[t], false, r, a, i);
    ...
    ot({
      ...
      htmlBuilder: function (e, t) {
        qr(e);
        for (var r, n, a = ft(e.body, t, true, ["mopen", "mclose"]), i = 0, o = 0, s = false, l = 0; l < a.length; l++) a[l].isMiddle ? s = true : (i = Math.max(a[l].height, i), o = Math.max(a[l].depth, o));
        if (i *= t.sizeMultiplier, o *= t.sizeMultiplier, r = "." === e.left ? xt(t, ["mopen"]) : Ar.leftRightDelim(e.left, i, o, t, e.mode, ["mopen"]), a.unshift(r), s) for (var h = 1; h < a.length; h++) {
          var m = a[h].isMiddle;
    ...
    var Nr = function (e, t) {
        ...
        if ("sout" === o) {
          ...
          var v = 0,
            b = 0,
            y = 0;
          /box/.test(o) ? (y = Math.max(t.fontMetrics().fboxrule, t.minRuleThickness), b = v = t.fontMetrics().fboxsep + ("colorbox" === o ? 0 : y)) : "angl" === o ? (v = 4 * (y = Math.max(t.fontMetrics().defaultRuleThickness, t.minRuleThickness)), b = Math.max(0, .25 - i.depth)) : b = v = m ? .2 : 0;
          r = Ft(i, o, v, b, t);
          /fbox|boxed|fcolorbox/.test(o) ? (r.style.borderStyle = "solid", r.style.borderWidth = V(y)) : "angl" === o && .049 !== y && (r.style.borderTopWidth = V(y), r.style.borderRightWidth = V(y));
          h = i.depth + b;
    ...
    function Gr(e, t, r) {
      ...
      var f = [],
        ...
        y = null != h ? [] : undefined;
      function x() {
        h && e.gullet.macros.set("\\@eqnsw", "1", true);
      }
      function w() {
        y && (e.gullet.macros.get("\\df@tag") ? (y.push(e.subparse([new Dr("\\df@tag")])), e.gullet.macros.set("\\df@tag", undefined, true)) : y.push(Boolean(h) && "1" === e.gullet.macros.get("\\@eqnsw")));
      }
      for (x(), b.push(Pr(e));;) {
        var k = e.parseExpression(false, m ? "\\end" : "\\\\");
        e.gullet.endGroup();
        e.gullet.beginGroup();
        k = {
          type: "ordgroup",
        ...
        if ("&" === S) {
          ...
          if ("\\end" === S) {
            w();
            1 === f.length && "styling" === k.type && 0 === k.body[0].body.length && (g.length > 1 || !c) && g.pop();
          ...
          e.consume();
          var M = undefined;
          " " !== e.gullet.future().text && (M = e.parseSizeGroup(true));
    ...
    var Yr = function (e, t) {
        ...
        if (e.tags && e.tags.some(function (e) {
          ...
          var H = h[r],
            ...
            L = e.tags[r],
            D = undefined;
          (D = true === L ? Ke.makeSpan(["eqn-num"], [], t) : false === L ? Ke.makeSpan([], [], t) : Ke.makeSpan([], ft(L, t, true), t)).depth = H.depth;
          D.height = H.height;
          O.push({
            type: "elem",
            elem: D,
        ...
        for (a = 0, q = 0; a < s || q < I.length; ++a, ++q) {
          for (var P = I[q] || {}, G = true; "separator" === P.type;) {
          ...
          if (!(a >= s)) {
            ...
            R.push(_);
            (a < s - 1 || e.hskipBeforeAndAfter) && 0 !== (W = l.deflt(P.postgap, p)) && ((C = Ke.makeSpan(["arraycolsep"], [])).style.width = V(W), R.push(C));
          }
        }
      ...
      Wr = function (e, t) {
        ...
        if (e.cols && e.cols.length > 0) {
          ...
          for (var b = g; b < v; b++) "align" === p[b].type ? (u += Xr[p[b].align], f && (d += "none "), f = true) : "separator" === p[b].type && f && (d += "|" === p[b].separator ? "solid " : "dashed ", f = false);
      ...
      _r = function (e, t) {
        ...
        var r,
          ...
          s = Gr(e.parser, {
            cols: a,
            addJot: true,
            autoTag: o ? undefined : Vr(e.envName),
            emptySingleRow: true,
            colSeparationType: i,
            maxNumCols: o ? 2 : undefined,
          ...
          for (var a, i, o = [], s = [o], l = 0; l < t.length; l++) {
            for (var h = t[l], m = {
              ...
              if (p[0] = {
                ...
                for (var d = 0; d < 2; d++) {
                  for (var f = true, g = c + 1; g < h.length; g++) {
    ...
    var rn = function (e, t) {
      ...
      nn = function (e, t) {
        ...
        if (e.hasBarLine ? (e.barSize ? (m = F(e.barSize, t), h = Ke.makeLineSpan("frac-line", t, m)) : h = Ke.makeLineSpan("frac-line", t), m = h.height, c = h.height) : (h = null, m = 0, c = t.fontMetrics().defaultRuleThickness), n.size === x.DISPLAY.size || "display" === e.size ? (u = t.fontMetrics().num1, p = m > 0 ? 3 * c : 7 * c, d = t.fontMetrics().denom1) : (m > 0 ? (u = t.fontMetrics().num2, p = c) : (u = t.fontMetrics().num3, p = 3 * c), d = t.fontMetrics().denom2), h) {
          ...
          u - o.depth - (w + .5 * m) < p && (u += p - (u - o.depth - (w + .5 * m)));
          w - .5 * m - (y.height - d) < p && (d += p - (w - .5 * m - (y.height - d)));
          var k = -(w - .5 * m);
          f = Ke.makeVList({
            positionType: "individualShift",
            children: [{
        ...
        return r = t.havingStyle(n), f.height *= r.sizeMultiplier / t.sizeMultiplier, f.depth *= r.sizeMultiplier / t.sizeMultiplier, g = n.size === x.DISPLAY.size ? t.fontMetrics().delim1 : n.size === x.SCRIPTSCRIPT.size ? t.havingStyle(x.SCRIPT).fontMetrics().delim2 : t.fontMetrics().delim2, v = null == e.leftDelim ? xt(t, ["mopen"]) : Ar.customSizedDelim(e.leftDelim, g, true, t.havingStyle(n), e.mode, ["mopen"]), b = e.continued ? Ke.makeSpan([]) : null == e.rightDelim ? xt(t, ["mclose"]) : Ar.customSizedDelim(e.rightDelim, g, true, t.havingStyle(n), e.mode, ["mclose"]), Ke.makeSpan(["mord"].concat(r.sizingClasses(t)), [v, Ke.makeSpan(["mfrac"], [f]), b], t);
      },
      an = function (e, t) {
    ...
    ot({
      ...
      handler: function (e, t, r) {
        var a = e.parser,
          ...
          l = "";
        if (r[0]) for (var h = Ut(r[0], "raw").string.split(","), m = 0; m < h.length; m++) {
          var c = h[m].split("=");
          if (2 === c.length) {
            var u = c[1].trim();
            switch (c[0].trim()) {
    ...
    var cn = function (e, t, r, n, a, i, o) {
      ...
      pn = function (e, t) {
        var r,
          ...
          a,
          i = false;
        "supsub" === e.type ? (r = e.sup, n = e.sub, a = Ut(e.base, "op"), i = true) : a = Ut(e, "op");
        var o,
          s = t.style,
          h = false;
        if (s.size === x.DISPLAY.size && a.symbol && !l.contains(un, a.name) && (h = true), a.symbol) {
      ...
      dn = function (e, t) {
        ...
        } else if (e.body) r = new zt("mo", Nt(e.body, t));else {
    ...
    var vn = function (e, t) {
      var r,
        ...
        i,
        o = false;
      if ("supsub" === e.type ? (r = e.sup, n = e.sub, a = Ut(e.base, "operatorname"), o = true) : a = Ut(e, "operatorname"), a.body.length > 0) {
        for (var s = a.body.map(function (e) {
          ...
          }), l = ft(s, t.withFont("mathrm"), true), h = 0; h < l.length; h++) {
          var m = l[h];
    ...
    function bn(e, t, r) {
      for (var n = ft(e, t, false), a = t.sizeMultiplier / r.sizeMultiplier, i = 0; i < n.length; i++) {
    ...
    ot({
      ...
      htmlBuilder: vn,
      mathmlBuilder: function (e, t) {
        for (var r = Nt(e.body, t.withFont("mathrm")), n = true, a = 0; a < r.length; a++) {
          var i = r[a];
          if (i instanceof Tt.SpaceNode) ;else if (i instanceof Tt.MathNode) switch (i.type) {
            ...
            case "mo":
              var o = i.children[0];
              1 === i.children.length && o instanceof Tt.TextNode ? o.text = o.text.replace(/\u2212/, "-").replace(/\u2217/, "*") : n = false;
              break;
            default:
              n = false;
          } else n = false;
    ...
    st({
      type: "ordgroup",
      htmlBuilder: function (e, t) {
        return e.semisimple ? Ke.makeFragment(ft(e.body, t, false)) : Ke.makeSpan(["mord"], ft(e.body, t, true), t);
      },
      mathmlBuilder: function (e, t) {
        return It(e.body, t, true);
      }
    });
    ot({
      type: "overline",
    ...
    ot({
      ...
      htmlBuilder: function (e, t) {
        var r = ft(e.body, t.withPhantom(), false);
        return Ke.makeFragment(r);
      },
      mathmlBuilder: function (e, t) {
        var r = Nt(e.body, t);
    ...
    ot({
      ...
      handler: function (e, t, r) {
        ...
        if (o) for (var s = "", l = 0; l < o.body.length; ++l) {
          if ("t" === (s = o.body[l].text)) a = true;else {
            if ("b" !== s) {
              a = false;
              i = false;
              break;
    ...
    st({
      ...
      htmlBuilder: function (e, t) {
        ...
        if (n && a) {
          u = Math.max(u, i, n.depth + .25 * c.xHeight);
          p = Math.max(p, c.sub2);
      ...
      mathmlBuilder: function (e, t) {
        var r,
          n = false;
        e.base && "horizBrace" === e.base.type && !!e.sup === e.base.isOver && (n = true, r = e.base.isOver);
        !e.base || "op" !== e.base.type && "operatorname" !== e.base.type || (e.base.parentIsSupSub = true);
        var a,
          i = [Rt(e.base, t)];
        if (e.sub && i.push(Rt(e.sub, t)), e.sup && i.push(Rt(e.sup, t)), n) a = r ? "mover" : "munder";else if (e.sub) {
          if (e.sup) {
            var o = e.base;
    ...
    Er("\\noexpand", function (e) {
      var t = e.popToken();
      return e.isExpandable(t.text) && (t.noexpand = true, t.treatAsRelax = true), {
        tokens: [t],
        numArgs: 0
      };
    });
    ...
    Er("\\newcommand", function (e) {
      return Ln(e, false, true);
    });
    Er("\\renewcommand", function (e) {
      return Ln(e, true, false);
    });
    Er("\\providecommand", function (e) {
      return Ln(e, true, true);
    });
    ...
    Er("\u2209", "\\notin");
    Er("\u2258", "\\html@mathml{\\mathrel{=\\kern{-1em}\\raisebox{0.4em}{$\\scriptsize\\frown$}}}{\\mathrel{\\char`\u2258}}");
    ...
    Er("\\bmod", "\\mathchoice{\\mskip1mu}{\\mskip1mu}{\\mskip5mu}{\\mskip5mu}\\mathbin{\\rm mod}\\mathchoice{\\mskip1mu}{\\mskip1mu}{\\mskip5mu}{\\mskip5mu}");
    Er("\\pod", "\\allowbreak\\mathchoice{\\mkern18mu}{\\mkern8mu}{\\mkern8mu}{\\mkern8mu}(#1)");
    Er("\\pmod", "\\pod{{\\rm mod}\\mkern6mu#1}");
    Er("\\mod", "\\allowbreak\\mathchoice{\\mkern18mu}{\\mkern12mu}{\\mkern12mu}{\\mkern12mu}{\\rm mod}\\,\\,#1");
    ...
    Er("\\LaTeX", "\\textrm{\\html@mathml{L\\kern-.36em\\raisebox{" + Fn + "}{\\scriptstyle A}\\kern-.15em\\TeX}{LaTeX}}");
    Er("\\KaTeX", "\\textrm{\\html@mathml{K\\kern-.17em\\raisebox{" + Fn + "}{\\scriptstyle A}\\kern-.15em\\TeX}{KaTeX}}");
    ...
    Er("\\dblcolon", '\\html@mathml{\\mathrel{\\vcentcolon\\mathrel{\\mkern-.9mu}\\vcentcolon}}{\\mathop{\\char"2237}}');
    Er("\\coloneqq", '\\html@mathml{\\mathrel{\\vcentcolon\\mathrel{\\mkern-1.2mu}=}}{\\mathop{\\char"2254}}');
    Er("\\Coloneqq", '\\html@mathml{\\mathrel{\\dblcolon\\mathrel{\\mkern-1.2mu}=}}{\\mathop{\\char"2237\\char"3d}}');
    Er("\\coloneq", '\\html@mathml{\\mathrel{\\vcentcolon\\mathrel{\\mkern-1.2mu}\\mathrel{-}}}{\\mathop{\\char"3a\\char"2212}}');
    Er("\\Coloneq", '\\html@mathml{\\mathrel{\\dblcolon\\mathrel{\\mkern-1.2mu}\\mathrel{-}}}{\\mathop{\\char"2237\\char"2212}}');
    Er("\\eqqcolon", '\\html@mathml{\\mathrel{=\\mathrel{\\mkern-1.2mu}\\vcentcolon}}{\\mathop{\\char"2255}}');
    Er("\\Eqqcolon", '\\html@mathml{\\mathrel{=\\mathrel{\\mkern-1.2mu}\\dblcolon}}{\\mathop{\\char"3d\\char"2237}}');
    Er("\\eqcolon", '\\html@mathml{\\mathrel{\\mathrel{-}\\mathrel{\\mkern-1.2mu}\\vcentcolon}}{\\mathop{\\char"2239}}');
    Er("\\Eqcolon", '\\html@mathml{\\mathrel{\\mathrel{-}\\mathrel{\\mkern-1.2mu}\\dblcolon}}{\\mathop{\\char"2212\\char"2237}}');
    Er("\\colonapprox", '\\html@mathml{\\mathrel{\\vcentcolon\\mathrel{\\mkern-1.2mu}\\approx}}{\\mathop{\\char"3a\\char"2248}}');
    Er("\\Colonapprox", '\\html@mathml{\\mathrel{\\dblcolon\\mathrel{\\mkern-1.2mu}\\approx}}{\\mathop{\\char"2237\\char"2248}}');
    Er("\\colonsim", '\\html@mathml{\\mathrel{\\vcentcolon\\mathrel{\\mkern-1.2mu}\\sim}}{\\mathop{\\char"3a\\char"223c}}');
    Er("\\Colonsim", '\\html@mathml{\\mathrel{\\dblcolon\\mathrel{\\mkern-1.2mu}\\sim}}{\\mathop{\\char"2237\\char"223c}}');
    Er("\u2237", "\\dblcolon");
    Er("\u2239", "\\eqcolon");
    Er("\u2254", "\\coloneqq");
    Er("\u2255", "\\eqqcolon");
    ...
    Er("\u2983", "\\lBrace");
    Er("\u2984", "\\rBrace");
    Er("\\minuso", "\\mathbin{\\html@mathml{{\\mathrlap{\\mathchoice{\\kern{0.145em}}{\\kern{0.145em}}{\\kern{0.1015em}}{\\kern{0.0725em}}\\circ}{-}}}{\\char`\u29b5}}");
    Er("\u29b5", "\\minuso");
    Er("\\darr", "\\downarrow");
    Er("\\dArr", "\\Downarrow");
    Er("\\Darr", "\\Downarrow");
    ...
    var Vn = {
      ...
      Gn = function () {
        ...
        return t.feed = function (e) {
          ...
          return this.macros.has(e) ? this.expandTokens([new Dr(e)]) : undefined;
        }, t.expandTokens = function (e) {
          var t = [],
            r = this.stack.length;
          for (this.pushTokens(e); this.stack.length > r;) {
            var n = this.expandOnce(true);
            n instanceof Dr && (n.treatAsRelax && (n.noexpand = false, n.treatAsRelax = false), t.push(this.stack.pop()));
          }
          return t;
      ...
      Xn = function () {
        ...
        return t.expect = function (e, t) {
          if (undefined === t && (t = true), this.fetch().text !== e) throw new n("Expected '" + e + "', got '" + this.fetch().text + "'", this.fetch());
          t && this.consume();
        }, t.consume = function () {
          this.nextToken = null;
        }, t.fetch = function () {
          ...
          if ("math" === this.mode && false === i.allowedInMath) throw new n("Can't use function '" + a + "' in math mode", r);
          ...
          e || 0 !== t.text.length || (t.text = "0pt", r = true);
          ...
          var a = this.parseExpression(false, "EOF");
          this.expect("EOF");
          ...
          if ("{" === i || "\\begingroup" === i) {
            ...
            var o = "{" === i ? "}" : "\\endgroup";
            this.gullet.beginGroup();
            var s = this.parseExpression(false, o),
              l = this.fetch();
            this.expect(o);
            this.gullet.endGroup();
            r = {
              ...
              loc: Lr.range(a, l),
              body: s,
              semisimple: "\\begingroup" === i || undefined
            };
