...
function texmath(e, t) {
  const n = texmath.mergeDelimiters(t && t.delimiters),
    a = t && t.outerSpace || false,
    o = t && t.katexOptions || {};
  o.throwOnError = o.throwOnError || false;
  o.macros = o.macros || t && t.macros;
  texmath.katex || (t && "object" == typeof t.engine ? texmath.katex = t.engine : "object" == typeof module ? texmath.katex = require("katex") : texmath.katex = {
    renderToString: () => "No math renderer found."
  });
  for (const t of n.inline) {
    a && "outerSpace" in t && (t.outerSpace = true);
    e.inline.ruler.before("escape", t.name, texmath.inline(t));
    e.renderer.rules[t.name] = (e, n) => t.tmpl.replace(/\$1/, texmath.render(e[n].content, !!t.displayMode, o));
  }
  for (const t of n.block) {
    e.block.ruler.before("fence", t.name, texmath.block(t));
    e.renderer.rules[t.name] = (e, n) => t.tmpl.replace(/\$2/, escapeHTML(e[n].info)).replace(/\$1/, texmath.render(e[n].content, true, o));
  }
}
...
texmath.block = e => function (t, n, a, o) {
  const r = t.bMarks[n] + t.tShift[n],
    s = t.src,
    m = s.startsWith(e.tag, e.rex.lastIndex = r) && (!e.pre || e.pre(s, false, r)) && e.rex.exec(s),
    l = !!m && r < e.rex.lastIndex && (!e.post || e.post(s, false, e.rex.lastIndex - 1));
  if (l && !o) {
...
"object" == typeof module && module.exports && (module.exports = texmath); //# sourceMappingURL=/sm/44278d0831047439fa59ec4544ff721944dc52c57407e98a2794f481db3accc2.map