Zotero.AI4Paper.Pinyin = new function () {
  ...
  //单词首字母获取
  this.getWordsCode = function (str) {
    str = str.toUpperCase();
  ...
  this._arraySearch = function (l1, l2) {
