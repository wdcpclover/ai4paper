function init() {
  ...
  Zotero.ZoteroIF.gptReaderSidePane_setStickyScroll(document);
  injectStyle();
...
function createMessageElement(param1, param2, param3, param4) {
  ...
  var2.style.fontSize = Zotero.Prefs.get("zoteroif.gptSidePaneFontSize");
  let var3 = Zotero.ZoteroIF.gptReaderSidePane_addExpandArrow(var2, param2, window);
  ...
  var5.innerHTML = param2 === 'user' ? Zotero.ZoteroIF.svg_icon_20px.avatar_user : Zotero.ZoteroIF.svg_icon_20px.gptviewReaderSidepane;
  var5.title = '点击以拷贝消息';
  var5.addEventListener("click", _0x52a92c => {
    Zotero.ZoteroIF.gptReaderSidePane_ChatMode_copyMessageSourceText(_0x52a92c);
  });
  const var6 = document.createElement('span');
  var6.classList.add('username');
  let var7 = Zotero.Prefs.get("zoteroif.gptUserName") ? Zotero.Prefs.get("zoteroif.gptUserName") : "User",
    var8 = Zotero.Prefs.get("zoteroif.gptservice") === 'OpenAI' ? 'ChatGPT' : Zotero.Prefs.get("zoteroif.gptservice");
  ...
  var9.style.fontSize = Zotero.Prefs.get("zoteroif.gptSidePaneFontSize");
  var9.style.textAlign = "left";
  param2 === 'user' || param2 === "assistant" && param3 ? (var9.innerText = param1, (param4?.["prompt"] || param4?.["fulltext"]) && (var9.innerText = param4?.["prompt"] + ':')) : Zotero.ZoteroIF.gptReaderSidePane_ChatMode_renderMessageContent(var9, param1);
  var9.messageSourceText = param1;
  Zotero.ZoteroIF.gptReaderSidePane_addClickEvent4ExpandArrow(var2, var3, var9, param2);
  ...
  if (param2 === 'user' && (param4?.['prompt'] || param4?.["fulltext"])) {
    ...
    var10.onclick = _0x3a6efb => {
      ...
      if (_0x3a6efb.shiftKey) {
        ...
        var11.id = "ZoteroIF-gptReaderSidePane-filesList-menupopup";
        var11.addEventListener("popuphidden", () => {
          Zotero.getMainWindow().document.querySelector("#browser").querySelectorAll("#ZoteroIF-gptReaderSidePane-filesList-menupopup").forEach(_0x31d165 => _0x31d165.remove());
        });
        ...
        Zotero.getMainWindow().document.querySelector("#browser").querySelectorAll("#ZoteroIF-gptReaderSidePane-filesList-menupopup").forEach(_0xb1ab2a => _0xb1ab2a.remove());
    ...
    var16.onclick = _0x55cf77 => {
      ...
      let var17 = var10.querySelector(".file-info"),
        var18 = Zotero.ZoteroIF.getCurrentReader();
      if (var18 && var18._item === var17.item) {
        Zotero.ZoteroIF.showProgressWindow(0x5dc, "❌ 打开附件【AI4paper】", "当前打开的就是该附件，无需再打开。");
        return;
      }
    ...
    let var20 = Zotero.ZoteroIF.findItemByIDORKey(param4?.["fileID"]),
...
function addQuickButtons(param6, param7) {
  ...
  var25.innerHTML = Zotero.ZoteroIF.svg_icon_16px.scrollTop;
  ...
  var25.addEventListener("mousedown", async _0x2b6abd => {
    ...
    if (_0x2b6abd.shiftKey) {
      Zotero.ZoteroIF.gptReaderSidePane_ChatMode_scrollTop(window);
      window.getSelection && window.getSelection().removeAllRanges();
      return;
    }
    _0x2b6abd.button === 0x0 && (Zotero.ZoteroIF.gptReaderSidePane_ChatMode_go2MessageTop(_0x2b6abd, true), window.getSelection && (await Zotero.Promise.delay(0x32), window.getSelection().removeAllRanges()));
  });
  var24.appendChild(var25);
  var25 = document.createElement('div');
  var25.classList.add('button', param6);
  var25.classList.add("quickButton-CopyMessage");
  var25.innerHTML = Zotero.ZoteroIF.svg_icon_16px.clipboard;
  var25.title = "拷贝消息";
  var25.addEventListener('mousedown', _0x54683d => {
    ...
    if (_0x54683d.shiftKey) {
      Zotero.ZoteroIF.gptReaderSidePane_ChatMode_copyAllMessages(false, window);
      return;
    }
    _0x54683d.button === 0x0 && Zotero.ZoteroIF.gptReaderSidePane_ChatMode_copyMessage(_0x54683d, true);
  });
  var24.appendChild(var25);
  var25 = document.createElement("div");
  var25.classList.add("button", param6);
  var25.classList.add("quickButton-CopyMessageSourceText");
  var25.innerHTML = Zotero.ZoteroIF.svg_icon_16px.markdown;
  ...
  var25.addEventListener("mousedown", _0x3cd517 => {
    ...
    if (_0x3cd517.shiftKey) {
      Zotero.ZoteroIF.gptReaderSidePane_ChatMode_copyAllMessages(true, window);
      return;
    }
    _0x3cd517.button === 0x0 && Zotero.ZoteroIF.gptReaderSidePane_ChatMode_copyMessageSourceText(_0x3cd517, true);
  });
  var24.appendChild(var25);
  var25 = document.createElement("div");
  var25.classList.add("button", param6);
  var25.classList.add("quickButton-SaveMessages");
  var25.innerHTML = Zotero.ZoteroIF.svg_icon_16px.save;
  ...
  var25.onclick = _0x4f552a => {
    ...
    Zotero.ZoteroIF._data_renderChatHistory_quickBtn_clickEvent = _0x4f552a;
  ...
  var25.innerHTML = Zotero.ZoteroIF.svg_icon_16px.rename_16px;
  var25.title = "修改消息";
  ...
  var24.appendChild(var25);
  param6 === 'assistant' && (var25 = document.createElement("div"), var25.classList.add("button", param6), var25.classList.add("quickButton-deleteMessages"), var25.innerHTML = Zotero.ZoteroIF.svg_icon_16px["delete"], var25.title = "删除消息", var25.addEventListener('click', _0x25e96a => {
...
function modifyMessage(param8) {
  Zotero.ZoteroIF._data_renderChatHistory_modifyMessage = null;
  ...
  let var31 = Zotero.ZoteroIF.openDialogByType_modal("modifyMessage", var29);
  if (!var31.trim()) {
...
function deleteMessages(param9) {
  Zotero.ZoteroIF._data_renderChatHistory_deleteMessages = null;
  ...
  if (var37) {
    ...
    Zotero.ZoteroIF._data_renderChatHistory_deleteMessages = var38;
...
function injectStyle() {
  const var40 = {
    ...
    var41 = var40[Zotero.Prefs.get("zoteroif.gptSidePaneDarkModeTheme")] || "#1e1e1e",
